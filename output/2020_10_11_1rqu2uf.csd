...
t 0 220
{ 3 CNT ; measures=5 measures_template=i 2 [0+0.5+$CNT*16] 1 0.75 [0.5*1/2] 8.04
i 2 + 1 3 [0.45*1/2] 8.06
i 2 + 1 0.75 [0.3*1/2] 8.02
i 2 + 1 3 [0.3*1/2] 8.07
i 2 + 1 0.5 [0.25*0/2] 8.02
i 2 + 1 2.75 [0.7*0/2] 8.10
i 2 + 1 1.5 [0.4*0/2] 8.07
i 2 + 1 3 [0.5*0/2] 8.07
i 2 + 1 1 [0.8*0/2] 8.11
i 2 + 1 1 [0.15*0/2] 8.10
i 2 + 1 1.25 [0.5*1/2] 8.05
i 2 + 1 1.5 [0.95*0/2] 8.05
i 2 + 1 0.25 [0.55*1/2] 8.07
i 2 + 1 1.5 [0.9*0/2] 8.09
i 2 + 1 0.25 [0.6*1/2] 8.07
i 2 + 1 1.25 [0.3*0/2] 8.11
i 2 + 1 1.5 [0.5*1/2] 8.06
i 2 + 1 0.25 [0.25*0/2] 8.07
i 2 + 1 2.75 [0.45*0/2] 8.02
i 2 + 1 0.5 [0.7*0/2] 8.01

((measures_template))
((measures_template))
}
b [5*4*3]
{ 4 CNT ; measures=2 measures_template=i 7 [0+0.5+$CNT*16] 1 0.25 [0.95*0/4] 8.07
i 7 + 1 0.25 [0.05*0/4] 8.06
i 7 + 1 3 [0.35*0/4] 8.01
i 7 + 1 1.25 [0.6*0/4] 8.01
i 7 + 1 0.5 [0.15*0/4] 8.11
i 7 + 1 1.5 [0.25*1/4] 8.04
i 7 + 1 0.5 [0.3*0/4] 8.01
i 7 + 1 1.25 [0.2*0/4] 8.05
i 2  1 0.75  8.04
i 2 + 1 3  8.06
i 2 + 1 0.75  8.02
i 2 + 1 3  8.07
...
i 2 + 1 2.75  8.02
i 2 + 1 0.5 0.7*0/2] 8.01
i 2 [0+0.5+$CNT*16] 1 0.75 [0.5*1/2] 8.04
i 2 + 1 3 [0.45*1/2] 8.06
i 2 + 1 0.75 [0.3*1/2] 8.02
i 2 + 1 3 [0.3*1/2] 8.07
i 2 + 1 0.5 [0.25*0/2] 8.02
