...
t 0 220
{ 3 CNT ; measures=5 measures_template=i 7 [0+0+$CNT*16] 1 0.5 [0.95*1/3] 8.06
i 7 + 1 1.5 [0.1*1/3] 8.02
i 7 + 1 1 [0.4*1/3] 8.11
i 7 + 1 2.75 [0.4*1/3] 8.04
i 7 + 1 3 [0.35*0/3] 8.03
i 7 + 1 0.5 [0.9*0/3] 8.09
i 7 + 1 0.5 [0.1*0/3] 8.01
i 7 + 1 1.5 [0.95*0/3] 8.02
i 7 + 1 0.5 [0.95*0/3] 8.01
i 7 + 1 1.25 [0.7*0/3] 8.04
i 7 + 1 3 [0.2*0/3] 8.05
i 7 + 1 2.75 [0.2*1/3] 8.11
i 7 + 1 2.75 [0.55*1/3] 8.01
i 7 + 1 0.25 [0.1*0/3] 8.02
i 7 + 1 1.5 [0.1*0/3] 8.09
i 7 + 1 1 [0.2*0/3] 8.06
i 7 + 1 1.25 [0.9*0/3] 8.08
i 7 + 1 3 [0.15*1/3] 8.03
i 7 + 1 1.25 [0.8*1/3] 8.08
i 7 + 1 2.75 [0.35*0/3] 8.03
((measures_template))
((measures_template))
((measures_template))
}
b [5*4*3]
{ 4 CNT ; measures=3 measures_template=((measures_template
))voices_template}
