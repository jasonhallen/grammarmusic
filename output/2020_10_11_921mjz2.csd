...
i 10 + 1 0.75   ;dorian
i 10 + 1 2.75   ;dorian
i 10 + 1 0.25  8+.03] ;dorian
((measure_locl))
i 10 [0+0+$CNT*12] 1 0.25 [0.65*1/3] [8+.09] ;dorian
i 10 + 1 2.75 [0.7*1/3] [8+.07] ;dorian
i 10 + 1 0.25 [0.9*0/3] [8+.09] ;dorian
i 10 + 1 0.75 [0.15*0/3] [8+.03] ;dorian
i 10 + 1 1.5 [0.6*0/3] [8+.09] ;dorian
i 10 + 1 3 [0.45*0/3] [8+.07] ;dorian
i 10 + 1 0.25 [0.45*1/3] [8+.09] ;dorian
i 10 + 1 0.25 [0.15*0/3] [8+.12] ;dorian
i 10 + 1 0.75 [0.7*0/3] [8+.00] ;dorian
i 10 + 1 0.75 [0.65*0/3] [8+.02] ;dorian
i 10 + 1 2.75 [0.1*0/3] [8+.03] ;dorian
i 10 + 1 0.25 [0.05*0/3] [8+.03] ;dorian
i 10 [0+0+$CNT*12] 1 0.25 [0.65*1/3] [8+.09] ;dorian
i 10 + 1 2.75 [0.7*1/3] [8+.07] ;dorian
i 10 + 1 0.25 [0.9*0/3] [8+.09] ;dorian
i 10 + 1 0.75 [0.15*0/3] [8+.03] ;dorian
