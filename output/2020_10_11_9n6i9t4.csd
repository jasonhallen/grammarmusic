...
t 0 400
{ 2 CNT ; measures=2 measures_template=i 6 [0+0.5+$CNT*16] 1 0.25 [0.25*0/2] 8.01
i 6 + 1 1.5 [0.6*0/2] 8.10
i 6 + 1 3 [0.15*0/2] 8.11
i 6 + 1 1.25 [0.55*1/2] 8.11
i 6 + 1 1.25 [0.75*0/2] 8.01
i 6 + 1 0.5 [0.7*0/2] 8.01
i 6 + 1 1.25 [0.2*0/2] 8.10
i 6 + 1 1.25 [0.3*0/2] 8.11
((measures_template))
((measures_template))
}
b [2*4*2]
{ 3 CNT ; measures=5 measures_template=((measures_template
))voices_template}
