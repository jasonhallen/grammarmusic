...
i 9 $BRAC1 0+0+$CNT*12 $BRAC2 1 0.75 $BRAC1 0.9*0/2 $BRAC2 $BRAC1 8+.00 $BRAC2 ;aeolian
i 9 + 1 0.25 $BRAC1 0.85*1/2 $BRAC2 $BRAC1 8+.10 $BRAC2 ;aeolian
i 9 + 1 3 $BRAC1 0.6*1/2 $BRAC2 $BRAC1 8+.00 $BRAC2 ;aeolian
i 9 $BRAC1 0+0+$CNT*12 $BRAC2 1 0.75 $BRAC1 0.9*0/2 $BRAC2 $BRAC1 8+.00 $BRAC2 ;aeolian
i 9 + 1 0.25 $BRAC1 0.85*1/2 $BRAC2 $BRAC1 8+.10 $BRAC2 ;aeolian
i 9 + 1 3 $BRAC1 0.6*1/2 $BRAC2 $BRAC1 8+.00 $BRAC2 ;aeolian
...
i 10 $BRAC1 0+0+$CNT*12 $BRAC2 1 1.5 $BRAC1 0.85*0/2 $BRAC2 $BRAC1 8+.07 $BRAC2 ;dorian
i 10 + 1 1.5 $BRAC1 0.35*0/2 $BRAC2 $BRAC1 8+.05 $BRAC2 ;dorian
i 10 + 1 0.5 $BRAC1 0.5*1/2 $BRAC2 $BRAC1 8+.02 $BRAC2 ;dorian
i 10 + 1 3 $BRAC1 0.45*1/2 $BRAC2 $BRAC1 8+.07 $BRAC2 ;dorian
i 10 + 1 1.25 $BRAC1 0.5*1/2 $BRAC2 $BRAC1 8+.03 $BRAC2 ;dorian
i 10 $BRAC1 0+0+$CNT*12 $BRAC2 1 1.5 $BRAC1 0.85*0/2 $BRAC2 $BRAC1 8+.07 $BRAC2 ;dorian
i 10 + 1 1.5 $BRAC1 0.35*0/2 $BRAC2 $BRAC1 8+.05 $BRAC2 ;dorian
i 10 + 1 0.5 $BRAC1 0.5*1/2 $BRAC2 $BRAC1 8+.02 $BRAC2 ;dorian
i 10 + 1 3 $BRAC1 0.45*1/2 $BRAC2 $BRAC1 8+.07 $BRAC2 ;dorian
