...
i 6 + 1 0.75   ;dorian
i 6 + 1 3  8+.05] ;dorian
i 6 [0+0+$CNT*12] 1 1.5 [0.95*0/2] [8+.03] ;dorian
i 6 + 1 0.75 [0.15*0/2] [8+.03] ;dorian
i 6 + 1 3 [0.25*1/2] [8+.05] ;dorian

}
b [12*4]
{ 2 CNT
i 10 [0+0+$CNT*12] 1 1.25 [0.2*0/6] [8+.05] ;dorian
i 10 + 1 1.25 [0.35*1/6] [8+.10] ;dorian
i 10 + 1 0.75 [0.2*0/6] [8+.12] ;dorian
i 10 + 1 0.25 [0.55*1/6] [8+.09] ;dorian
i 10 [0+0+$CNT*12] 1 2.75 [0.85*0/6] [8+.02] ;dorian
i 10 + 1 1.5 [0.85*1/6] [8+.00] ;dorian
i 10 + 1 3 [0.2*0/6] [8+.10] ;dorian
i 10 + 1 2.75 [0.15*0/6] [8+.05] ;dorian
i 10 + 1 2.75 [0.6*1/6] [8+.05] ;dorian
i 6 [0+0.75+$CNT*12] 1 0.5 [0.1*0/6] [8+.05] ;dorian
i 6 + 1 1.25 [0.35*1/6] [8+.05] ;dorian
i 6 + 1 1.5 [0.65*0/6] [8+.07] ;dorian
i 10 [0+0.75+$CNT*12] 1 2.75 [0.95*0/6] [8+.09] ;dorian
i 10 + 1 1.25 [0.6*0/6] [8+.05] ;dorian
i 10 + 1 0.75 [0.6*0/6] [8+.00] ;dorian
i 1 [0+0.75+$CNT*12] 1 1 [0.95*1/6] [8+.05] ;dorian
i 1 + 1 1.25 [0.85*0/6] [8+.12] ;dorian
i 1 + 1 3 [0.05*1/6] [8+.02] ;dorian
i 1 + 1 1.25 [0.15*0/6] [8+.00] ;dorian
i 1 + 1 0.5 [0.8*0/6] [8+.12] ;dorian
i 4 [0+0.5+$CNT*12] 1 3 [0.15*1/6] [8+.00] ;dorian
i 4 + 1 3 [0.95*1/6] [8+.09] ;dorian
i 4 + 1 0.25 [0.8*0/6] [8+.12] ;dorian
i 4 + 1 0.25 [0.75*0/6] [8+.10] ;dorian
i 4 + 1 1.25 [0.8*1/6] [8+.07] ;dorian
