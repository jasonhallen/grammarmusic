...
t 0 330
{ 3 CNT 
i 4 [0+0.75+$CNT*12] 1 3 [0.1*0/5] [8+.05] ;aeolian
i 4 + 1 0.75 [0.45*0/5] [8+.08] ;aeolian
i 4 + 1 1.25 [0.4*1/5] [8+.00] ;aeolian
i 4 + 1 3 [0.25*0/5] [8+.05] ;aeolian
i 7 [0+0+$CNT*12] 1 0.25 [0.55*0/5] [8+.12] ;aeolian
i 7 + 1 0.5 [0.65*0/5] [8+.08] ;aeolian
i 7 + 1 0.75 [0.9*0/5] [8+.12] ;aeolian
i 7 + 1 1 [0.65*1/5] [8+.00] ;aeolian
i 1 [0+0.75+$CNT*12] 1 0.75 [0.2*1/5] [8+.07] ;aeolian
i 1 + 1 0.25 [0.1*0/5] [8+.05] ;aeolian
i 1 + 1 1 [0.35*0/5] [8+.12] ;aeolian
i 1 + 1 1.25 [0.65*0/5] [8+.05] ;aeolian
i 1 [0+0.5+$CNT*12] 1 3 [0.35*1/5] [8+.05] ;aeolian
i 1 + 1 2.75 [0.15*0/5] [8+.02] ;aeolian
i 1 + 1 0.75 [0.85*1/5] [8+.03] ;aeolian
i 1 + 1 0.75 [0.45*1/5] [8+.02] ;aeolian
i 1 + 1 2.75 [0.45*1/5] [8+.05] ;aeolian
i 7 [0+0+$CNT*12] 1 0.25 [0.5*1/5] [8+.08] ;aeolian
i 7 + 1 0.25 [0.55*1/5] [8+.10] ;aeolian
i 7 + 1 2.75 [0.05*1/5] [8+.02] ;aeolian
i 7 + 1 0.5 [0.2*1/5] [8+.05] ;aeolian
i 7 + 1 1.5 [0.8*0/5] [8+.10] ;aeolian
i 7 + 1 2.75 [0.25*0/5] [8+.00] ;aeolian
i 7 + 1 1.25 [0.1*1/5] [8+.05] ;aeolian
i 7 + 1 2.75 [0.05*0/5] [8+.02] ;aeolian
i 7 + 1 1.5 [0.9*1/5] [8+.07] ;aeolian
i 7 + 1 0.5 [0.25*0/5] [8+.12] ;aeolian
i 7 + 1 0.5 [0.6*0/5] [8+.00] ;aeolian
i 7 + 1 0.25 [0.7*0/5] [8+.10] ;aeolian
...
i 8 + 1 1   ;ionian
i 8 + 1 3  8+.04] ;ionian
i 8 [0+0.5+$CNT*12] 1 1.5 [0.75*1/4] [8+.11] ;ionian
i 8 + 1 1.25 [0.6*0/4] [8+.11] ;ionian
i 8 + 1 1 [0.8*1/4] [8+.12] ;ionian
i 8 + 1 3 [0.25*0/4] [8+.04] ;ionian
i 8 [0+0.5+$CNT*12] 1 1.5 [0.75*1/4] [8+.11] ;ionian
i 8 + 1 1.25 [0.6*0/4] [8+.11] ;ionian
i 8 + 1 1 [0.8*1/4] [8+.12] ;ionian
i 8 + 1 3 [0.25*0/4] [8+.04] ;ionian
