...
t 0 280
{ 4 CNT 
i 2 [0+0.5+$CNT*12] 1 1 [0.45*0/6] [8+.07] ;dorian
i 2 + 1 1.5 [0.8*0/6] [8+.03] ;dorian
i 2 + 1 0.75 [0.95*0/6] [8+.10] ;dorian
i 9 [0+0+$CNT*12] 1 1 [0.8*1/6] [8+.12] ;dorian
i 9 + 1 1.25 [0.95*0/6] [8+.10] ;dorian
i 9 + 1 2.75 [0.9*0/6] [8+.05] ;dorian
i 9 + 1 1.25 [0.05*1/6] [8+.03] ;dorian
i 10 [0+0.5+$CNT*12] 1 1.25 [0.1*0/6] [8+.10] ;dorian
i 10 + 1 1.5 [0.2*0/6] [8+.07] ;dorian
i 10 + 1 1.5 [0.45*1/6] [8+.02] ;dorian
i 10 + 1 1.5 [0.9*1/6] [8+.12] ;dorian
i 4 [0+0+$CNT*12] 1 1.5 [0.4*1/6] [8+.03] ;dorian
i 4 + 1 2.75 [0.2*0/6] [8+.09] ;dorian
i 4 + 1 1.5 [0.25*0/6] [8+.03] ;dorian
i 4 + 1 1 [0.2*0/6] [8+.12] ;dorian
i 3 [0+0+$CNT*12] 1 0.5 [0.4*1/6] [8+.02] ;dorian
i 3 + 1 1.25 [0.55*0/6] [8+.05] ;dorian
i 3 + 1 0.75 [0.2*1/6] [8+.03] ;dorian
i 3 + 1 0.25 [0.8*0/6] [8+.05] ;dorian
i 3 + 1 0.75 [0.3*0/6] [8+.12] ;dorian
i 3 + 1 0.5 [0.25*0/6] [8+.00] ;dorian
i 3 + 1 2.75 [0.15*0/6] [8+.12] ;dorian
i 3 + 1 3 [0.45*0/6] [8+.09] ;dorian
i 3 + 1 0.75 [0.5*1/6] [8+.00] ;dorian
i 3 + 1 2.75 [0.3*1/6] [8+.02] ;dorian
i 3 + 1 1.25 [0.15*0/6] [8+.12] ;dorian
i 3 + 1 1.25 [0.1*0/6] [8+.00] ;dorian
i 4 [0+0.5+$CNT*12] 1 3 [0.85*0/6] [8+.03] ;dorian
i 4 + 1 0.25 [0.55*1/6] [8+.12] ;dorian
i 4 + 1 1 [0.45*0/6] [8+.12] ;dorian
...
i 3 + 1 0.75   ;ionian
i 3 + 1 1  8+.07] ;ionian
i 3 [0+0.5+$CNT*12] 1 1.5 [0.5*0/4] [8+.11] ;ionian
i 3 + 1 1.25 [0.3*1/4] [8+.12] ;ionian
i 3 + 1 0.75 [0.55*0/4] [8+.09] ;ionian
i 3 + 1 1 [0.2*0/4] [8+.07] ;ionian
i 3 [0+0.5+$CNT*12] 1 1.5 [0.5*0/4] [8+.11] ;ionian
i 3 + 1 1.25 [0.3*1/4] [8+.12] ;ionian
i 3 + 1 0.75 [0.55*0/4] [8+.09] ;ionian
i 3 + 1 1 [0.2*0/4] [8+.07] ;ionian
