...
b [2*4*4]
{ 3 CNT ; measures=2 measures_template=i 5 [0+0+$CNT*16] 1 0.25 [0.25*0/6] 8.08
i 5 + 1 1 [0.75*1/6] 8.04
i 5 + 1 1.25 [0.95*0/6] 8.09
i 5 + 1 0.75 [0.5*0/6] 8.04
i 5 + 1 3 [0.15*1/6] 8.07
i 5 + 1 2.75 [0.8*0/6] 8.03
i 5 + 1 3 [0.65*1/6] 8.11
i 5 + 1 0.5 [0.7*0/6] 8.01
i 8  1 0.25  8.04
i 8 + 1 2.75  8.08
i 8 + 1 0.5  8.05
i 8 + 1 1.25  8.06
...
i 8 + 1 2.75  8.09
i 8 + 1 1.5  8.03
i 8 + 1 0.5 0.5*0/2] 8.04
i 8 [0+0+$CNT*16] 1 0.25 [0.65*0/2] 8.04
i 8 + 1 2.75 [0.35*1/2] 8.08
i 8 + 1 0.5 [0.95*0/2] 8.05
i 8 + 1 1.25 [0.35*0/2] 8.06
i 8 + 1 1 [0.7*0/2] 8.04
i 8 + 1 2.75 [0.85*0/2] 8.09
i 8 + 1 1.5 [0.95*0/2] 8.03
i 8 + 1 0.5 [0.5*0/2] 8.04
i 8 [0+0+$CNT*16] 1 0.25 [0.65*0/2] 8.04
i 8 + 1 2.75 [0.35*1/2] 8.08
i 8 + 1 0.5 [0.95*0/2] 8.05
