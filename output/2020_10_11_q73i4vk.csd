...
t 0 250
{ 3 CNT 
i 8 [0+0+$CNT*12] 1 0.75 [0.45*1/2] [8+.03] ;dorian
i 8 + 1 1.25 [0.7*0/2] [8+.12] ;dorian
i 8 + 1 1.5 [0.4*0/2] [8+.03] ;dorian
i 8 + 1 0.25 [0.05*0/2] [8+.07] ;dorian
i 8 + 1 1.5 [0.25*1/2] [8+.02] ;dorian
i 10 [0+0.25+$CNT*12] 1 0.5 [0.05*0/2] [8+.03] ;dorian
i 10 + 1 1.25 [0.7*1/2] [8+.03] ;dorian
i 10 + 1 1.5 [0.3*0/2] [8+.03] ;dorian
i 10 + 1 3 [0.5*0/2] [8+.10] ;dorian

}
b [12*3]
{ 3 CNT
i 10 [0+0+$CNT*12] 1 3 [0.05*0/3] [8+.00] ;aeolian
i 10 + 1 0.75 [0.8*0/3] [8+.12] ;aeolian
i 10 + 1 0.25 [0.95*0/3] [8+.05] ;aeolian
i 10 + 1 0.25 [0.6*0/3] [8+.02] ;aeolian
i 10 [0+0+$CNT*12] 1 1.25 [0.25*0/3] [8+.03] ;aeolian
i 10 + 1 0.75 [0.35*1/3] [8+.12] ;aeolian
i 10 + 1 1.25 [0.35*1/3] [8+.12] ;aeolian
i 10 + 1 1.5 [0.9*0/3] [8+.08] ;aeolian
i 10 + 1 2.75 [0.5*1/3] [8+.00] ;aeolian
i 8 [0+0+$CNT*12] 1 3 [0.25*0/3] [8+.03] ;aeolian
i 8 + 1 1 [0.85*0/3] [8+.05] ;aeolian
i 8 + 1 1.25 [0.25*0/3] [8+.10] ;aeolian
