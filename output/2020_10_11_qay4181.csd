...
((measures_template))
((measures_template))
, measures_template=i 9 [0+0+$CNT*16] 1 0.5 [0.85*0/5] 8.10
i 9 + 1 1 [0.65*1/5] 8.07
i 9 + 1 2.75 [0.9*0/5] 8.08
i 9 + 1 1 [0.05*0/5] 8.05
i 9 + 1 1.25 [0.65*0/5] 8.05
i 9 + 1 0.5 [0.05*0/5] 8.09
i 9 + 1 2.75 [0.1*0/5] 8.01
i 9 + 1 0.5 [0.3*0/5] 8.11
i 9 + 1 1 [0.25*0/5] 8.05
i 9 + 1 0.5 [0.6*0/5] 8.01
i 9 + 1 0.25 [0.25*0/5] 8.05
i 9 + 1 2.75 [0.5*0/5] 8.08
i 9 + 1 0.75 [0.55*0/5] 8.07
i 9 + 1 0.25 [0.9*0/5] 8.03
i 9 + 1 1.25 [0.6*0/5] 8.09
i 9 + 1 0.25 [0.05*1/5] 8.07
i 9 + 1 1 [0.2*0/5] 8.10
i 9 + 1 3 [0.1*0/5] 8.02
i 9 + 1 3 [0.35*1/5] 8.03
i 9 + 1 0.75 [0.6*0/5] 8.10
((measures_template))
((measures_template))
((measures_template))
((measures_template))
...
b [5*4*1]
{ 2 CNT
; voices_template=i 9  1 0.5  8.10
i 9 + 1 1  8.07
i 9 + 1 2.75  8.08
i 9 + 1 1  8.05
i 9 + 1 1.25  8.05
...
i 9 + 1 3  8.03
i 9 + 1 0.75 0.6*0/5] 8.10
i 9 [0+0+$CNT*16] 1 0.5 [0.85*0/5] 8.10
i 9 + 1 1 [0.65*1/5] 8.07
i 9 + 1 2.75 [0.9*0/5] 8.08
i 9 + 1 1 [0.05*0/5] 8.05
i 9 + 1 1.25 [0.65*0/5] 8.05
...
i 9 + 1 3 [0.35*1/5] 8.03
i 9 + 1 0.75 [0.6*0/5] 8.10
, measures_template=i 10 [0+0+$CNT*16] 1 0.75 [0.45*0/5] 8.10
i 10 + 1 1.5 [0.1*1/5] 8.11
i 10 + 1 1.25 [0.35*1/5] 8.02
i 10 + 1 1 [0.75*0/5] 8.06
i 10 + 1 1.5 [0.15*0/5] 8.06
i 10 + 1 2.75 [0.2*0/5] 8.03
i 10 + 1 1.25 [0.55*0/5] 8.09
i 10 + 1 0.25 [0.25*0/5] 8.06
i 10 + 1 0.5 [0.9*0/5] 8.09
i 10 + 1 0.5 [0.4*0/5] 8.02
i 10 + 1 3 [0.3*0/5] 8.06
i 10 + 1 1.25 [0.85*0/5] 8.07
i 10 + 1 0.75 [0.8*1/5] 8.02
i 10 + 1 0.75 [0.95*0/5] 8.01
i 10 + 1 2.75 [0.9*0/5] 8.11
i 10 + 1 0.5 [0.85*1/5] 8.11
i 9  1 0.5  8.10
i 9 + 1 1  8.07
i 9 + 1 2.75  8.08
i 9 + 1 1  8.05
