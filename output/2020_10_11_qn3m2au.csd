...
i 10  1 3   ;dorian
i 10 + 1 1   ;dorian
i 10 + 1 0.75  8+.02] ;dorian
i 10 [0+0.25+$CNT*12] 1 3 [0.5*0/4] [8+.05] ;dorian
i 10 + 1 1 [0.7*0/4] [8+.12] ;dorian
i 10 + 1 0.75 [0.7*1/4] [8+.02] ;dorian
i 10 [0+0.25+$CNT*12] 1 3 [0.5*0/4] [8+.05] ;dorian
i 10 + 1 1 [0.7*0/4] [8+.12] ;dorian
i 10 + 1 0.75 [0.7*1/4] [8+.02] ;dorian
i 10 [0+0.25+$CNT*12] 1 3 [0.5*0/4] [8+.05] ;dorian
...
i 1  1 3   ;dorian
i 1 + 1 2.75   ;dorian
i 1 + 1 0.75  8+.03] ;dorian
i 1 [0+0.25+$CNT*12] 1 3 [0.7*1/4] [8+.12] ;dorian
i 1 + 1 2.75 [0.25*0/4] [8+.07] ;dorian
i 1 + 1 0.75 [0.6*0/4] [8+.03] ;dorian
i 1 [0+0.25+$CNT*12] 1 3 [0.7*1/4] [8+.12] ;dorian
i 1 + 1 2.75 [0.25*0/4] [8+.07] ;dorian
i 1 + 1 0.75 [0.6*0/4] [8+.03] ;dorian
i 1 [0+0.25+$CNT*12] 1 3 [0.7*1/4] [8+.12] ;dorian
