...
t 0 310
{ 1 CNT
; voices_template=((measures_template))
((measures_template))
((measures_template))
...
b [7*4*1]
{ 1 CNT
; voices_template=i 2  1 1.5  8.05
i 2 + 1 0.5  8.09
i 2 + 1 1.5  8.11
i 2 + 1 3  8.10
i 2 + 1 0.75  8.11
...
i 2 + 1 0.25  8.09
i 2 + 1 0.75  8.04
i 2 + 1 2.75 0.05*1/3] 8.06
i 2 [0+0+$CNT*16] 1 1.5 [0.95*1/3] 8.05
i 2 + 1 0.5 [0.95*1/3] 8.09
i 2 + 1 1.5 [0.25*0/3] 8.11
i 2 + 1 3 [0.3*1/3] 8.10
i 2 + 1 0.75 [0.5*1/3] 8.11
i 2 + 1 0.25 [0.25*0/3] 8.11
i 2 + 1 0.75 [0.25*0/3] 8.09
i 2 + 1 1.5 [0.45*1/3] 8.01
i 2 + 1 0.25 [0.7*0/3] 8.08
i 2 + 1 3 [0.6*0/3] 8.07
i 2 + 1 3 [0.35*0/3] 8.02
i 2 + 1 0.75 [0.8*1/3] 8.11
i 2 + 1 0.75 [0.25*0/3] 8.09
i 2 + 1 1 [0.8*0/3] 8.11
i 2 + 1 2.75 [0.05*0/3] 8.05
i 2 + 1 3 [0.6*0/3] 8.11
i 2 + 1 1 [0.75*0/3] 8.04
i 2 + 1 2.75 [0.85*1/3] 8.10
i 2 + 1 0.75 [0.15*0/3] 8.05
i 2 + 1 1.5 [0.8*1/3] 8.05
i 2 + 1 0.75 [0.2*0/3] 8.06
i 2 + 1 1.5 [0.5*0/3] 8.03
i 2 + 1 1 [0.05*0/3] 8.02
i 2 + 1 1.25 [0.9*1/3] 8.05
i 2 + 1 2.75 [0.4*0/3] 8.03
i 2 + 1 0.25 [0.25*1/3] 8.09
i 2 + 1 0.75 [0.45*0/3] 8.04
i 2 + 1 2.75 [0.05*1/3] 8.06
i 2 [0+0+$CNT*16] 1 1.5 [0.95*1/3] 8.05
i 2 + 1 0.5 [0.95*1/3] 8.09
i 2 + 1 1.5 [0.25*0/3] 8.11
...
i 2 + 1 0.75 [0.45*0/3] 8.04
i 2 + 1 2.75 [0.05*1/3] 8.06
, measures_template=i 7 [0+0+$CNT*16] 1 1.5 [0.45*0/3] 8.08
i 7 + 1 1.25 [0.15*0/3] 8.01
i 7 + 1 1 [0.35*1/3] 8.07
i 7 + 1 2.75 [0.25*1/3] 8.10
i 7 + 1 0.75 [0.35*0/3] 8.07
i 7 + 1 3 [0.3*0/3] 8.02
i 7 + 1 0.25 [0.75*0/3] 8.09
i 7 + 1 0.5 [0.05*0/3] 8.02
i 7 + 1 0.5 [0.7*1/3] 8.11
i 7 + 1 1 [0.65*0/3] 8.10
i 7 + 1 0.75 [0.3*0/3] 8.07
i 7 + 1 0.75 [0.85*0/3] 8.07
i 7 + 1 3 [0.3*1/3] 8.08
i 7 + 1 2.75 [0.8*0/3] 8.01
i 7 + 1 1.5 [0.8*0/3] 8.10
i 7 + 1 0.25 [0.15*0/3] 8.09
i 2  1 1.5  8.05
i 2 + 1 0.5  8.09
i 2 + 1 1.5  8.11
i 2 + 1 3  8.10
