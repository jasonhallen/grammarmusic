...
t 0 400
{ 1 CNT 
i 3 [0+0+$CNT*12] 1 0.75 [0.45*1/2] ((mode))
i 3 + 1 2.75 [0.5*1/2] ((mode))
i 3 + 1 0.5 [0.05*0/2] ((mode))
i 3 + 1 0.75 [0.25*1/2] ((mode))
i 3 + 1 1 [0.55*1/2] ((mode))
i 3 + 1 2.75 [0.9*0/2] ((mode))
i 3 + 1 0.25 [0.6*0/2] ((mode))
i 3 + 1 3 [0.05*0/2] ((mode))
i 3 + 1 2.75 [0.75*1/2] ((mode))
i 3 + 1 1 [0.6*0/2] ((mode))
i 3 + 1 1.25 [0.2*0/2] ((mode))
i 3 + 1 3 [0.35*1/2] ((mode))
i 8 [0+0.25+$CNT*12] 1 1 [0.05*1/2] ((mode))
i 8 + 1 0.5 [0.85*1/2] ((mode))
i 8 + 1 0.75 [0.45*1/2] ((mode))
i 8 + 1 1 [0.5*1/2] ((mode))
i 8 + 1 1 [0.05*0/2] ((mode))
i 8 + 1 1.25 [0.55*1/2] ((mode))
i 8 + 1 0.75 [0.85*1/2] ((mode))
i 8 + 1 0.25 [0.8*0/2] ((mode))
i 8 + 1 0.75 [0.4*0/2] ((mode))
i 8 + 1 0.75 [0.4*0/2] ((mode))
i 8 + 1 2.75 [0.6*1/2] ((mode))
i 8 + 1 2.75 [0.85*0/2] ((mode))

}
b [12*1]
{ 2 CNT
i 6 [0+0+$CNT*12] 1 2.75 [0.05*0/2] .05
i 6 + 1 2.75 [0.25*0/2] .05
i 6 + 1 0.25 [0.3*0/2] .05
i 6 + 1 0.25 [0.9*1/2] .05
i 6 + 1 1 [0.85*0/2] .05
i 6 + 1 0.5 [0.75*0/2] .05
i 6 + 1 0.25 [0.3*0/2] .05
i 6 + 1 0.5 [0.2*0/2] .05
i 6 + 1 3 [0.05*0/2] .05
i 6 + 1 0.5 [0.75*0/2] .05
i 6 + 1 0.75 [0.05*0/2] .05
i 6 + 1 0.75 [0.1*0/2] .05
i 3 [0+0+$CNT*12] 1 0.25 [0.8*0/2] .05
i 3 + 1 1.5 [0.05*1/2] .05
i 3 + 1 0.5 [0.35*0/2] .05
i 3 + 1 0.75 [0.7*1/2] .05
i 3 + 1 2.75 [0.65*0/2] .05
i 3 + 1 0.25 [0.95*0/2] .05
i 3 + 1 1.25 [0.45*0/2] .05
i 3 + 1 1.5 [0.85*0/2] .05
i 3 + 1 0.25 [0.2*1/2] .05
i 3 + 1 0.5 [0.35*1/2] .05
i 3 + 1 2.75 [0.4*0/2] .05
i 3 + 1 0.25 [0.8*0/2] .05
