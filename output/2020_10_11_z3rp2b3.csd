...
t 0 320
{ 3 CNT ; measures=4 measures_template=i 10 [0+0+$CNT*16] 1 0.5 [0.4*1/2] 8.10
i 10 + 1 2.75 [0.6*0/2] 8.11
i 10 + 1 2.75 [0.1*0/2] 8.08
i 10 + 1 2.75 [0.85*1/2] 8.05
i 10 + 1 3 [0.25*0/2] 8.03
i 10 + 1 0.5 [0.4*0/2] 8.11
i 10 + 1 1 [0.2*0/2] 8.06
i 10 + 1 1.25 [0.8*0/2] 8.05
i 10 + 1 0.25 [0.7*0/2] 8.05
i 10 + 1 3 [0.5*0/2] 8.03
i 10 + 1 0.25 [0.3*1/2] 8.05
i 10 + 1 1 [0.45*0/2] 8.01
i 10 + 1 0.25 [0.95*0/2] 8.04
i 10 + 1 3 [0.85*1/2] 8.07
i 10 + 1 3 [0.2*0/2] 8.01
i 10 + 1 1.25 [0.95*0/2] 8.10
((measures_template))
((measures_template))
}
b [4*4*3]
{ 3 CNT ; measures=4 measures_template=i 1 [0+0+$CNT*16] 1 1.25 [0.65*1/6] 8.03
i 1 + 1 2.75 [0.75*1/6] 8.09
i 1 + 1 3 [0.8*0/6] 8.02
i 1 + 1 0.25 [0.65*0/6] 8.09
i 1 + 1 0.25 [0.65*0/6] 8.04
i 1 + 1 1 [0.4*0/6] 8.03
i 1 + 1 1 [0.7*0/6] 8.11
i 1 + 1 0.75 [0.2*0/6] 8.07
i 1 + 1 0.75 [0.05*0/6] 8.07
i 1 + 1 1.25 [0.05*0/6] 8.04
i 1 + 1 0.5 [0.15*0/6] 8.04
i 1 + 1 3 [0.1*0/6] 8.03
i 1 + 1 1.5 [0.2*0/6] 8.03
i 1 + 1 0.25 [0.6*0/6] 8.03
i 1 + 1 1.5 [0.9*1/6] 8.11
i 1 + 1 0.75 [0.3*0/6] 8.01
i 10  1 0.5  8.10
i 10 + 1 2.75  8.11
i 10 + 1 2.75  8.08
i 10 + 1 2.75  8.05
...
i 10 + 1 3  8.01
i 10 + 1 1.25 0.95*0/2] 8.10
i 10 [0+0+$CNT*16] 1 0.5 [0.4*1/2] 8.10
i 10 + 1 2.75 [0.6*0/2] 8.11
i 10 + 1 2.75 [0.1*0/2] 8.08
i 10 + 1 2.75 [0.85*1/2] 8.05
i 10 + 1 3 [0.25*0/2] 8.03
