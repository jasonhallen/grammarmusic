...
t 0 350
{ 3 CNT 
i 5 [0+0+$CNT*12] 1 1 [0.6*0/2] [8+.04] ;mixolydian
i 5 + 1 1.25 [0.4*0/2] [8+.09] ;mixolydian
i 5 + 1 0.5 [0.8*0/2] [8+.02] ;mixolydian
i 5 + 1 3 [0.4*0/2] [8+.00] ;mixolydian
i 5 + 1 0.25 [0.2*0/2] [8+.00] ;mixolydian
i 5 + 1 0.5 [0.4*1/2] [8+.00] ;mixolydian
i 5 + 1 1 [0.35*0/2] [8+.04] ;mixolydian
i 5 + 1 0.5 [0.2*1/2] [8+.12] ;mixolydian
i 5 + 1 0.75 [0.55*0/2] [8+.00] ;mixolydian
i 5 + 1 1.25 [0.7*1/2] [8+.05] ;mixolydian
i 5 + 1 2.75 [0.65*0/2] [8+.00] ;mixolydian
i 5 + 1 0.25 [0.5*1/2] [8+.00] ;mixolydian
i 5 [0+0+$CNT*12] 1 1 [0.6*0/2] [8+.04] ;mixolydian
i 5 + 1 1.25 [0.4*0/2] [8+.09] ;mixolydian
i 5 + 1 0.5 [0.8*0/2] [8+.02] ;mixolydian
i 5 + 1 3 [0.4*0/2] [8+.00] ;mixolydian
...
b [12*3]
{ 1 CNT
i 1 [0+0+$CNT*12] 1 0.5 [0.55*0/2] [8+.12] ;aeolian
i 1 + 1 0.25 [0.5*0/2] [8+.03] ;aeolian
i 1 + 1 2.75 [0.15*0/2] [8+.00] ;aeolian
i 1 + 1 2.75 [0.75*0/2] [8+.10] ;aeolian
i 1 + 1 0.25 [0.85*1/2] [8+.12] ;aeolian
i 1 + 1 1 [0.15*0/2] [8+.03] ;aeolian
i 1 + 1 0.25 [0.9*0/2] [8+.02] ;aeolian
i 1 + 1 2.75 [0.05*0/2] [8+.08] ;aeolian
i 1 + 1 0.25 [0.45*0/2] [8+.12] ;aeolian
i 1 + 1 0.25 [0.15*1/2] [8+.08] ;aeolian
i 1 + 1 0.5 [0.7*0/2] [8+.05] ;aeolian
i 1 + 1 1.5 [0.25*0/2] [8+.00] ;aeolian
i 1 [0+0+$CNT*12] 1 0.5 [0.55*0/2] [8+.12] ;aeolian
i 1 + 1 0.25 [0.5*0/2] [8+.03] ;aeolian
i 1 + 1 2.75 [0.15*0/2] [8+.00] ;aeolian
i 1 + 1 2.75 [0.75*0/2] [8+.10] ;aeolian
