...
t 0 200
 { 5 CNT
i 2 [0+0+$CNT*3*4] 1 0.5 [0.65*1/6] [8+.01] ;phrygian
i 2 + 1 0.25 [0.75*0/6] [8+.07] ;phrygian
i 2 + 1 0.5 [0.65*0/6] [8+.05] ;phrygian
i 2 + 1 1 [0.9*0/6] [8+.12] ;phrygian
 i 2 + 1 1.5 [0.9*0/6] [8+.05] ;phrygian
i 2 + 1 0.25 [0.1*0/6] [8+.08] ;phrygian
i 2 + 1 0.25 [0.15*1/6] [8+.10] ;phrygian
i 2 + 1 0.25 [0.2*0/6] [8+.05] ;phrygian
 i 2 + 1 0.75 [0.5*0/6] [8+.12] ;phrygian
i 2 + 1 2.75 [0.8*1/6] [8+.00] ;phrygian
i 2 + 1 0.5 [0.35*0/6] [8+.05] ;phrygian
i 2 + 1 0.5 [0.5*0/6] [8+.07] ;phrygian

}
b  [3*4*5]
 { 4 CNT
i 5 [0+0.5+$CNT*4*4] 1 1.5 [0.75*0/6] [9+.00] ;phrygian
i 5 + 1 0.5 [0.8*1/6] [9+.00] ;phrygian
i 5 + 1 0.75 [0.05*0/6] [9+.00] ;phrygian
i 5 + 1 2.75 [0.3*0/6] [9+.10] ;phrygian
 i 5 + 1 0.75 [0.25*1/6] [9+.07] ;phrygian
i 5 + 1 0.5 [0.55*1/6] [9+.03] ;phrygian
i 5 + 1 0.5 [0.2*1/6] [9+.08] ;phrygian
i 5 + 1 0.5 [0.2*0/6] [9+.00] ;phrygian
 i 5 + 1 0.5 [0.75*0/6] [9+.08] ;phrygian
i 5 + 1 0.5 [0.75*1/6] [9+.01] ;phrygian
i 5 + 1 1 [0.6*0/6] [9+.12] ;phrygian
i 5 + 1 0.25 [0.15*1/6] [9+.05] ;phrygian
 i 5 + 1 1 [0.8*0/6] [9+.00] ;phrygian
i 5 + 1 0.75 [0.65*1/6] [9+.12] ;phrygian
i 5 + 1 3 [0.75*1/6] [9+.07] ;phrygian
i 5 + 1 0.25 [0.15*1/6] [9+.01] ;phrygian
