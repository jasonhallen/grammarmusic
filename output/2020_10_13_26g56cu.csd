...
t 0 280
{ 5 CNT
i 1 [0+0.5+$CNT*3*4] 1 2.75 [0.5*0/6] [8+.10] ;locrian
i 1 + 1 1 [0.9*0/6] [8+.08] ;locrian
i 1 + 1 0.25 [0.8*1/6] [8+.08] ;locrian
i 1 + 1 0.75 [0.35*0/6] [8+.05] ;locrian
 i 1 + 1 1 [0.25*1/6] [8+.00] ;locrian
i 1 + 1 0.25 [0.05*1/6] [8+.10] ;locrian
i 1 + 1 1 [0.9*0/6] [8+.00] ;locrian
i 1 + 1 0.5 [0.6*1/6] [8+.06] ;locrian
 i 1 + 1 0.75 [0.85*0/6] [8+.00] ;locrian
i 1 + 1 2.75 [0.85*0/6] [8+.12] ;locrian
i 1 + 1 0.75 [0.3*0/6] [8+.08] ;locrian
i 1 + 1 0.25 [0.85*0/6] [8+.00] ;locrian

}
b  [3*4*5]
{ 3 CNT
i 5 [0+0.5+$CNT*4*4] 1 2.75 [0.1*1/6] [10+.05] ;locrian
i 5 + 1 3 [0.05*0/6] [10+.05] ;locrian
i 5 + 1 0.25 [0.3*0/6] [10+.00] ;locrian
i 5 + 1 0.25 [0.6*0/6] [10+.00] ;locrian
 i 5 + 1 0.5 [0.95*0/6] [10+.00] ;locrian
i 5 + 1 3 [0.05*0/6] [10+.08] ;locrian
i 5 + 1 1.5 [0.6*0/6] [10+.03] ;locrian
i 5 + 1 3 [0.05*0/6] [10+.05] ;locrian
 i 5 + 1 0.25 [0.35*0/6] [10+.00] ;locrian
i 5 + 1 0.25 [0.3*0/6] [10+.01] ;locrian
i 5 + 1 1 [0.2*1/6] [10+.00] ;locrian
i 5 + 1 0.25 [0.9*1/6] [10+.01] ;locrian
 i 5 + 1 0.75 [0.35*0/6] [10+.03] ;locrian
i 5 + 1 0.5 [0.1*1/6] [10+.01] ;locrian
i 5 + 1 0.75 [0.55*0/6] [10+.00] ;locrian
i 5 + 1 0.25 [0.2*0/6] [10+.00] ;locrian
}
