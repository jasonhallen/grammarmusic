...
t 0 280
 { 3 CNT
i 5 [0+0.75+$CNT*3*4] 1 0.25 [0.3*0/6] [9+.10] ;locrian
i 5 + 1 0.75 [0.2*0/6] [9+.00] ;locrian
i 5 + 1 0.25 [0.35*1/6] [9+.06] ;locrian
i 5 + 1 0.25 [0.35*0/6] [9+.00] ;locrian
 i 5 + 1 0.25 [0.05*0/6] [9+.00] ;locrian
i 5 + 1 0.5 [0.15*1/6] [9+.12] ;locrian
i 5 + 1 0.5 [0.65*1/6] [9+.00] ;locrian
i 5 + 1 3 [0.05*0/6] [9+.08] ;locrian
 i 5 + 1 0.25 [0.15*0/6] [9+.00] ;locrian
i 5 + 1 0.5 [0.4*1/6] [9+.03] ;locrian
i 5 + 1 0.25 [0.2*0/6] [9+.00] ;locrian
i 5 + 1 3 [0.55*1/6] [9+.05] ;locrian

}
b  [3*4*3]
{ 4 CNT
i 11 [0+0.5+$CNT*4*4] 1 0.75 [0.7*0/6] [8+.06] ;locrian
i 11 + 1 0.25 [0.4*0/6] [8+.01] ;locrian
i 11 + 1 0.5 [0.75*1/6] [8+.12] ;locrian
i 11 + 1 2.75 [0.65*0/6] [8+.05] ;locrian
 i 11 + 1 1.25 [0.9*0/6] [8+.01] ;locrian
i 11 + 1 0.75 [0.4*0/6] [8+.00] ;locrian
i 11 + 1 2.75 [0.6*0/6] [8+.06] ;locrian
i 11 + 1 1 [0.95*0/6] [8+.08] ;locrian
 i 11 + 1 0.25 [0.45*1/6] [8+.06] ;locrian
i 11 + 1 0.25 [0.1*0/6] [8+.01] ;locrian
i 11 + 1 0.5 [0.7*0/6] [8+.00] ;locrian
i 11 + 1 0.25 [0.45*1/6] [8+.00] ;locrian
 i 11 + 1 0.25 [0.75*1/6] [8+.08] ;locrian
i 11 + 1 2.75 [0.1*1/6] [8+.06] ;locrian
i 11 + 1 1 [0.4*1/6] [8+.01] ;locrian
i 11 + 1 0.25 [0.3*0/6] [8+.12] ;locrian
