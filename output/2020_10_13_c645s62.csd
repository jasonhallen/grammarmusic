...
t 0 200
 { 3 CNT
i 2 [0+0.25+$CNT*3*4] 1 3 [0.9*1/6] [7+.00] ;atonal
i 2 + 1 3 [0.95*0/6] [7+.08] ;atonal
i 2 + 1 1.25 [0.35*0/6] [7+.03] ;atonal
i 2 + 1 0.25 [0.8*0/6] [7+.12] ;atonal
 i 2 + 1 0.25 [0.55*0/6] [7+.07] ;atonal
i 2 + 1 0.25 [0.7*1/6] [7+.07] ;atonal
i 2 + 1 2.75 [0.65*1/6] [7+.02] ;atonal
i 2 + 1 2.75 [0.65*1/6] [7+.01] ;atonal
 i 2 + 1 0.75 [0.1*1/6] [7+.07] ;atonal
i 2 + 1 1.5 [0.25*1/6] [7+.09] ;atonal
i 2 + 1 0.5 [0.95*0/6] [7+.00] ;atonal
i 2 + 1 0.75 [0.1*0/6] [7+.12] ;atonal

}
  { 3 CNT
i 8 [0+0+$CNT*4*4] 1 1.5 [0.8*0/6] [7+.05] ;atonal
i 8 + 1 0.5 [0.3*0/6] [7+.04] ;atonal
i 8 + 1 0.75 [0.45*0/6] [7+.10] ;atonal
i 8 + 1 1.5 [0.4*0/6] [7+.03] ;atonal
 i 8 + 1 1 [0.3*1/6] [7+.09] ;atonal
i 8 + 1 1.5 [0.6*0/6] [7+.11] ;atonal
i 8 + 1 1.25 [0.9*0/6] [7+.11] ;atonal
i 8 + 1 0.25 [0.05*1/6] [7+.09] ;atonal
 i 8 + 1 1.25 [0.55*0/6] [7+.08] ;atonal
i 8 + 1 3 [0.75*0/6] [7+.08] ;atonal
i 8 + 1 1.25 [0.95*1/6] [7+.07] ;atonal
i 8 + 1 0.5 [0.75*0/6] [7+.00] ;atonal
 i 8 + 1 0.25 [0.05*1/6] [7+.08] ;atonal
i 8 + 1 0.75 [0.6*0/6] [7+.11] ;atonal
i 8 + 1 1 [0.5*1/6] [7+.10] ;atonal
i 8 + 1 0.5 [0.85*1/6] [7+.07] ;atonal
