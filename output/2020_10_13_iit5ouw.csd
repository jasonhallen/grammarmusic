...
t 0 230
{ 4 CNT
i 10 [0+0.25+$CNT*3*4] 1 0.25 [0.65*0/6] [9+.07] ;atonal
i 10 + 1 2.75 [0.7*0/6] [9+.12] ;atonal
i 10 + 1 0.25 [0.1*0/6] [9+.03] ;atonal
i 10 + 1 2.75 [0.6*0/6] [9+.06] ;atonal
 i 10 + 1 1.25 [0.35*0/6] [9+.06] ;atonal
i 10 + 1 0.75 [0.6*0/6] [9+.00] ;atonal
i 10 + 1 1.25 [0.5*0/6] [9+.03] ;atonal
i 10 + 1 0.5 [0.6*0/6] [9+.03] ;atonal
 i 10 + 1 0.5 [0.45*0/6] [9+.00] ;atonal
i 10 + 1 1.5 [0.25*1/6] [9+.08] ;atonal
i 10 + 1 1.25 [0.95*0/6] [9+.06] ;atonal
i 10 + 1 0.5 [0.5*1/6] [9+.10] ;atonal

}b  [3*4*4]
{ 3 CNT
i 3 [0+0.75+$CNT*4*4] 1 1.25 [0.05*1/6] [8+.09] ;atonal
i 3 + 1 0.25 [0.75*0/6] [8+.00] ;atonal
i 3 + 1 1 [0.3*0/6] [8+.12] ;atonal
i 3 + 1 1.25 [0.65*1/6] [8+.09] ;atonal
 i 3 + 1 0.25 [0.05*0/6] [8+.05] ;atonal
i 3 + 1 0.5 [0.05*0/6] [8+.07] ;atonal
i 3 + 1 0.5 [0.95*1/6] [8+.00] ;atonal
i 3 + 1 1 [0.2*1/6] [8+.10] ;atonal
 i 3 + 1 0.25 [0.9*0/6] [8+.04] ;atonal
i 3 + 1 0.25 [0.95*0/6] [8+.00] ;atonal
i 3 + 1 0.75 [0.1*0/6] [8+.01] ;atonal
i 3 + 1 2.75 [0.15*1/6] [8+.10] ;atonal
 i 3 + 1 1.5 [0.9*0/6] [8+.08] ;atonal
i 3 + 1 0.5 [0.1*1/6] [8+.05] ;atonal
i 3 + 1 1 [0.6*1/6] [8+.02] ;atonal
i 3 + 1 0.25 [0.25*1/6] [8+.05] ;atonal
}
