...
t 0 280
{ 3 CNT
i 10 [0+0+$CNT*3*4] 1 0.25 [0.5*0/6] [9+.10] ;phrygian
i 10 + 1 0.75 [0.6*0/6] [9+.10] ;phrygian
i 10 + 1 3 [0.5*0/6] [9+.08] ;phrygian
i 10 + 1 1.5 [0.55*0/6] [9+.12] ;phrygian
 i 10 + 1 1.5 [0.55*1/6] [9+.03] ;phrygian
i 10 + 1 0.25 [0.6*0/6] [9+.07] ;phrygian
i 10 + 1 1.5 [0.3*1/6] [9+.01] ;phrygian
i 10 + 1 0.5 [0.75*0/6] [9+.08] ;phrygian
 i 10 + 1 0.5 [0.9*0/6] [9+.03] ;phrygian
i 10 + 1 0.25 [0.5*1/6] [9+.05] ;phrygian
i 10 + 1 3 [0.7*0/6] [9+.00] ;phrygian
i 10 + 1 0.25 [0.65*0/6] [9+.00] ;phrygian

}
b  [3*4*3]
{ 5 CNT
i 3 [0+0.5+$CNT*4*4] 1 0.25 [0.45*0/6] [7+.12] ;phrygian
i 3 + 1 2.75 [0.65*1/6] [7+.05] ;phrygian
i 3 + 1 2.75 [0.6*0/6] [7+.03] ;phrygian
i 3 + 1 0.25 [0.55*1/6] [7+.07] ;phrygian
 i 3 + 1 0.25 [0.7*1/6] [7+.03] ;phrygian
i 3 + 1 0.25 [0.15*0/6] [7+.05] ;phrygian
i 3 + 1 0.25 [0.45*0/6] [7+.03] ;phrygian
i 3 + 1 3 [0.3*0/6] [7+.10] ;phrygian
 i 3 + 1 0.5 [0.55*1/6] [7+.01] ;phrygian
i 3 + 1 0.5 [0.2*1/6] [7+.12] ;phrygian
i 3 + 1 1.5 [0.1*0/6] [7+.07] ;phrygian
i 3 + 1 1 [0.35*0/6] [7+.08] ;phrygian
 i 3 + 1 0.75 [0.1*1/6] [7+.00] ;phrygian
i 3 + 1 1.25 [0.55*0/6] [7+.01] ;phrygian
i 3 + 1 0.25 [0.7*0/6] [7+.12] ;phrygian
i 3 + 1 0.75 [0.95*1/6] [7+.03] ;phrygian
}
