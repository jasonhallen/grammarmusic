...
t 0 260
{ 3 CNT
i 8 [0+0.5+$CNT*3*4] 1 0.25 [0.6*0/6] [8+.00] ;aeolian
i 8 + 1 0.5 [0.35*1/6] [8+.10] ;aeolian
i 8 + 1 3 [0.6*0/6] [8+.12] ;aeolian
i 8 + 1 2.75 [0.35*1/6] [8+.05] ;aeolian
 i 8 + 1 0.25 [0.75*0/6] [8+.10] ;aeolian
i 8 + 1 0.25 [0.5*0/6] [8+.07] ;aeolian
i 8 + 1 1 [0.1*0/6] [8+.08] ;aeolian
i 8 + 1 0.5 [0.3*0/6] [8+.00] ;aeolian
 i 8 + 1 1.25 [0.15*1/6] [8+.10] ;aeolian
i 8 + 1 2.75 [0.7*0/6] [8+.10] ;aeolian
i 8 + 1 2.75 [0.1*0/6] [8+.02] ;aeolian
i 8 + 1 0.5 [0.85*0/6] [8+.00] ;aeolian
}
b  [3*4*3]
{ 5 CNT
i 12 [0+0+$CNT*4*4] 1 0.5 [0.1*0/6] [10+.00] ;aeolian
i 12 + 1 0.5 [0.95*1/6] [10+.12] ;aeolian
i 12 + 1 0.25 [0.35*1/6] [10+.07] ;aeolian
i 12 + 1 1.5 [0.05*1/6] [10+.07] ;aeolian
 i 12 + 1 0.75 [0.25*0/6] [10+.07] ;aeolian
i 12 + 1 0.25 [0.25*0/6] [10+.00] ;aeolian
i 12 + 1 3 [0.55*0/6] [10+.08] ;aeolian
i 12 + 1 0.25 [0.85*1/6] [10+.00] ;aeolian
 i 12 + 1 0.25 [0.65*1/6] [10+.05] ;aeolian
i 12 + 1 1 [0.35*0/6] [10+.12] ;aeolian
i 12 + 1 2.75 [0.15*0/6] [10+.08] ;aeolian
i 12 + 1 0.5 [0.55*0/6] [10+.05] ;aeolian
 i 12 + 1 0.25 [0.1*1/6] [10+.00] ;aeolian
i 12 + 1 0.25 [0.3*1/6] [10+.10] ;aeolian
i 12 + 1 2.75 [0.1*1/6] [10+.12] ;aeolian
i 12 + 1 0.25 [0.05*0/6] [10+.00] ;aeolian
}
