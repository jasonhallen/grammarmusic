...
t 0 260
; locrian tr808 voices=1
b [(6*4*8*1)-5*4*8]

{ 8 CNT
i 2 [0+0.5+$CNT*5*4] 1 0.5 [0.5*1/1] [6+.00]
 i 2 + 1 0.5 [0.25*0/1] [6+.12]
 i 2 + 1 0.5 [0.3*0/1] [6+.08]
 i 2 + 1 0.5 [0.2*1/1] [6+.12]
 i 2 + 1 0.75 [0.85*0/1] [6+.05]
 i 2 + 1 3 [0.6*1/1] [6+.12]
 i 2 + 1 2.75 [0.9*0/1] [6+.10]
 i 2 + 1 1 [0.6*0/1] [6+.00]
 i 2 + 1 0.25 [0.4*0/1] [6+.10]
 i 2 + 1 1 [0.8*1/1] [6+.05]
 i 2 + 1 1.25 [0.25*0/1] [6+.10]
 i 2 + 1 1.25 [0.45*0/1] [6+.01]
 i 2 + 1 0.5 [0.3*1/1] [6+.08]
 i 2 + 1 0.5 [0.35*0/1] [6+.05]
 i 2 + 1 1.5 [0.3*0/1] [6+.05]
 i 2 + 1 3 [0.85*1/1] [6+.03]
 i 2 + 1 0.5 [0.6*0/1] [6+.08]
 i 2 + 1 3 [0.6*1/1] [6+.00]
 i 2 + 1 1.5 [0.8*0/1] [6+.00]
 i 2 + 1 1.25 [0.95*0/1] [6+.06]
}


i 2 + 1 1.5 [0.6*0/1] [6+.12]
 i 2 + 1 0.5 [0.25*0/1] [6+.12]
 i 2 + 1 0.5 [0.3*0/1] [6+.08]
 i 2 + 1 0.5 [0.2*1/1] [6+.12]
 i 2 + 1 0.75 [0.85*0/1] [6+.05]
 ...
 i 2 + 1 0.25 [0.4*0/1] [6+.10]
 i 2 + 1 1 [0.8*1/1] [6+.05]
 i 2 + 1 0.5 [0.9*0/1] [6+.12]
 i 2 + 1 1.25 [0.45*0/1] [6+.01]
 i 2 + 1 0.5 [0.3*1/1] [6+.08]
 i 2 + 1 0.5 [0.35*0/1] [6+.05]
 i 2 + 1 1.5 [0.3*0/1] [6+.05]
 i 2 + 1 3 [0.85*1/1] [6+.03]
 i 2 + 1 0.5 [0.35*1/1] [6+.00]
 i 2 + 1 3 [0.6*1/1] [6+.00]
 i 2 + 1 1.5 [0.8*0/1] [6+.00]
 i 2 + 1 1.25 [0.95*0/1] [6+.06]
 i 2 + 1 1.5 [0.6*0/1] [6+.12]
 ...
 i 2 + 1 0.5 [0.3*0/1] [6+.08]
 i 2 + 1 0.5 [0.2*1/1] [6+.12]
 i 2 + 1 0.25 [0.65*1/1] [6+.08]
 i 2 + 1 3 [0.6*1/1] [6+.12]
 i 2 + 1 2.75 [0.9*0/1] [6+.10]
 i 2 + 1 0.25 [0.4*0/1] [6+.03]
 i 2 + 1 0.25 [0.4*0/1] [6+.10]
 i 2 + 1 1 [0.7*0/1] [6+.05]
 i 2 + 1 0.5 [0.9*0/1] [6+.12]
 i 2 + 1 1.25 [0.45*0/1] [6+.01]
 i 2 + 1 0.5 [0.3*1/1] [6+.08]
 i 2 + 1 1.5 [0.85*1/1] [6+.03]
 i 2 + 1 1.5 [0.3*0/1] [6+.05]
 i 2 + 1 3 [0.85*1/1] [6+.03]
 i 2 + 1 0.5 [0.35*1/1] [6+.00]
 i 2 + 1 3 [0.6*1/1] [6+.00]
 ...
 i 2 + 1 0.5 [0.3*0/1] [6+.08]
 i 2 + 1 0.5 [0.2*1/1] [6+.12]
 i 2 + 1 0.25 [0.3*0/1] [6+.10]
 i 2 + 1 3 [0.6*1/1] [6+.12]
 i 2 + 1 2.75 [0.9*0/1] [6+.10]
 i 2 + 1 0.25 [0.4*0/1] [6+.03]
 i 2 + 1 0.25 [0.4*0/1] [6+.10]
 i 2 + 1 1 [0.4*0/1] [6+.05]
 i 2 + 1 0.5 [0.9*0/1] [6+.12]
 i 2 + 1 1.25 [0.45*0/1] [6+.01]
 i 2 + 1 0.5 [0.3*1/1] [6+.08]
 i 2 + 1 1.5 [0.85*1/1] [6+.03]
 ...
 i 2 + 1 0.5 [0.25*0/1] [6+.12]
 i 2 + 1 0.5 [0.3*0/1] [6+.08]
 i 2 + 1 1.5 [0.3*1/1] [6+.05]
 i 2 + 1 3 [0.75*0/1] [6+.05]
 i 2 + 1 3 [0.6*1/1] [6+.12]
 i 2 + 1 2.75 [0.9*0/1] [6+.10]
 i 2 + 1 0.25 [0.4*0/1] [6+.03]
 i 2 + 1 0.25 [0.4*0/1] [6+.10]
