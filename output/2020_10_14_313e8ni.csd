...
{ 5 CNT
i 18 [0+0+$CNT*5*4] 1 3 [0.8*0/1] [7+.06]
 i 18 + 1 0.25 [0.65*1/1] [7+.02]
 i 18 + 1 1.5 [0.25*1/1] [7+.08]
 i 18 + 1 0.25 [0.95*0/1] [7+.09]
 i 18 + 1 3 [0.25*0/1] [7+.01]
 i 18 + 1 2.75 [0.35*0/1] [7+.10]
 i 18 + 1 3 [0.45*0/1] [7+.12]
 i 18 + 1 0.5 [0.8*1/1] [7+.05]
 i 18 + 1 1.25 [0.2*1/1] [7+.08]
 i 18 + 1 1.25 [0.3*0/1] [7+.07]
 i 18 + 1 0.75 [0.4*0/1] [7+.05]
 i 18 + 1 3 [0.2*0/1] [7+.04]
 i 18 + 1 2.75 [0.9*1/1] [7+.08]
 i 18 + 1 0.5 [0.5*0/1] [7+.07]
 i 18 + 1 1.25 [0.3*0/1] [7+.00]
 i 18 + 1 0.25 [0.85*1/1] [7+.12]
 i 18 + 1 0.75 [0.25*0/1] [7+.11]
 i 18 + 1 0.75 [0.75*0/1] [7+.12]
 i 18 + 1 1.25 [0.55*1/1] [7+.03]
 i 18 + 1 2.75 [0.45*0/1] [7+.09]
}


i 18 + 1 1 [0.7*0/1] [7+.11]
 i 18 + 1 0.25 [0.65*1/1] [7+.02]
 i 18 + 1 1.5 [0.25*1/1] [7+.08]
 i 18 + 1 0.25 [0.95*0/1] [7+.09]
 i 18 + 1 3 [0.25*0/1] [7+.01]
 ...
 i 18 + 1 0.5 [0.8*1/1] [7+.05]
 i 18 + 1 1.25 [0.2*1/1] [7+.08]
 i 18 + 1 0.5 [0.85*1/1] [7+.02]
 i 18 + 1 0.25 [0.35*0/1] [7+.03]
 i 18 + 1 3 [0.2*0/1] [7+.04]
 i 18 + 1 0.5 [0.35*0/1] [7+.01]
 i 18 + 1 0.5 [0.5*0/1] [7+.07]
 i 18 + 1 0.5 [0.35*0/1] [7+.03]
 i 18 + 1 0.25 [0.85*1/1] [7+.12]
 i 18 + 1 0.75 [0.25*0/1] [7+.11]
 i 18 + 1 0.75 [0.75*0/1] [7+.12]
 i 18 + 1 1.5 [0.7*1/1] [7+.10]
 i 18 + 1 2.75 [0.45*0/1] [7+.09]
 i 18 + 1 1 [0.7*0/1] [7+.11]
 i 18 + 1 0.25 [0.65*1/1] [7+.02]
 i 18 + 1 1.5 [0.25*1/1] [7+.08]
 ...
 i 18 + 1 2.75 [0.45*0/1] [7+.09]
 i 18 + 1 1 [0.7*0/1] [7+.11]
 i 18 + 1 0.5 [0.6*0/1] [7+.06]
 i 18 + 1 1.5 [0.25*1/1] [7+.08]
 i 18 + 1 0.5 [0.45*1/1] [7+.04]
 i 18 + 1 3 [0.25*0/1] [7+.01]
 i 18 + 1 2.75 [0.35*0/1] [7+.10]
 i 18 + 1 0.5 [0.7*0/1] [7+.12]
 i 18 + 1 0.5 [0.8*1/1] [7+.05]
