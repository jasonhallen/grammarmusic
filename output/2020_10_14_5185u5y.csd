...
{ 6 CNT
i 1 [0+0+$CNT*4*4] 1 1 [0.95*0/2] [9+.08]
 i 1 + 1 0.25 [0.6*1/2] [9+.07]
 i 1 + 1 1.25 [0.35*0/2] [9+.10]
 i 1 + 1 0.5 [0.95*0/2] [9+.03]
 i 1 + 1 2.75 [0.25*0/2] [9+.08]
 i 1 + 1 0.5 [0.8*0/2] [9+.02]
 i 1 + 1 1.25 [0.8*0/2] [9+.01]
 i 1 + 1 0.5 [0.55*0/2] [9+.11]
 i 1 + 1 0.25 [0.2*0/2] [9+.04]
 i 1 + 1 0.5 [0.65*0/2] [9+.01]
 i 1 + 1 0.5 [0.75*1/2] [9+.11]
 i 1 + 1 1.5 [0.25*1/2] [9+.02]
 i 1 + 1 2.75 [0.85*0/2] [9+.03]
 i 1 + 1 0.5 [0.75*0/2] [9+.08]
 i 1 + 1 0.25 [0.4*1/2] [9+.04]
 i 1 + 1 1.5 [0.3*0/2] [9+.02]
}


i 1 + 1 0.5 [0.9*1/2] [9+.05]
 i 1 + 1 0.25 [0.6*1/2] [9+.07]
 i 1 + 1 1.25 [0.35*0/2] [9+.10]
 i 1 + 1 0.5 [0.95*0/2] [9+.03]
 i 1 + 1 0.25 [0.8*0/2] [9+.01]
 i 1 + 1 0.5 [0.8*0/2] [9+.02]
 i 1 + 1 1.25 [0.8*0/2] [9+.01]
 i 1 + 1 0.5 [0.55*0/2] [9+.11]
 i 1 + 1 0.5 [0.8*0/2] [9+.09]
 i 1 + 1 0.5 [0.65*0/2] [9+.01]
 i 1 + 1 0.5 [0.75*1/2] [9+.11]
 i 1 + 1 1.5 [0.25*1/2] [9+.02]
 i 1 + 1 2.75 [0.85*0/2] [9+.03]
 ...
 i 1 + 1 0.25 [0.4*1/2] [9+.04]
 i 1 + 1 0.75 [0.45*0/2] [9+.04]
 i 1 + 1 0.25 [0.6*0/2] [9+.11]
 i 1 + 1 0.75 [0.9*1/2] [9+.07]
 i 1 + 1 1.25 [0.35*0/2] [9+.10]
 i 1 + 1 0.25 [0.8*0/2] [9+.10]
 i 1 + 1 0.25 [0.8*0/2] [9+.01]
 i 1 + 1 2.75 [0.3*0/2] [9+.05]
...
{ 7 CNT
i 6 [0+0.5+$CNT*3*4] 1 0.25 [0.4*1/2] [6+.01]
 i 6 + 1 0.25 [0.45*0/2] [6+.09]
 i 6 + 1 2.75 [0.7*1/2] [6+.10]
 i 6 + 1 0.25 [0.85*0/2] [6+.08]
 i 6 + 1 0.5 [0.5*0/2] [6+.04]
 i 6 + 1 0.25 [0.55*0/2] [6+.08]
 i 6 + 1 0.25 [0.95*1/2] [6+.00]
 i 6 + 1 0.25 [0.95*0/2] [6+.11]
 i 6 + 1 0.75 [0.25*0/2] [6+.11]
 i 6 + 1 0.75 [0.45*0/2] [6+.09]
 i 6 + 1 0.25 [0.95*0/2] [6+.11]
 i 6 + 1 1.25 [0.9*0/2] [6+.03]
}


i 6 + 1 3 [0.7*0/2] [6+.03]
 i 6 + 1 0.25 [0.45*0/2] [6+.09]
 i 6 + 1 0.25 [0.75*0/2] [6+.00]
 i 6 + 1 0.25 [0.85*0/2] [6+.08]
 i 6 + 1 0.5 [0.5*0/2] [6+.04]
 i 6 + 1 0.25 [0.55*0/2] [6+.08]
 i 6 + 1 0.25 [0.95*1/2] [6+.00]
 i 6 + 1 0.25 [0.3*1/2] [6+.09]
 i 6 + 1 0.75 [0.25*0/2] [6+.11]
 i 6 + 1 0.75 [0.45*0/2] [6+.09]
 i 6 + 1 0.25 [0.95*0/2] [6+.11]
 i 6 + 1 1.25 [0.9*0/2] [6+.03]
 i 6 + 1 0.75 [0.45*0/2] [6+.08]
 i 6 + 1 0.25 [0.45*0/2] [6+.09]
 i 6 + 1 0.25 [0.75*0/2] [6+.00]
 i 6 + 1 0.25 [0.85*0/2] [6+.08]
 i 6 + 1 0.5 [0.5*0/2] [6+.04]
