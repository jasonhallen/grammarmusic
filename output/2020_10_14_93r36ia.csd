...
{ 6 CNT
i 18 [0+0+$CNT*3*4] 1 0.75 [0.75*0/2] [9+.05]
 i 18 + 1 0.75 [0.8*0/2] [9+.02]
 i 18 + 1 0.25 [0.7*0/2] [9+.09]
 i 18 + 1 0.25 [0.6*0/2] [9+.12]
 i 18 + 1 0.25 [0.9*1/2] [9+.00]
 i 18 + 1 0.75 [0.35*0/2] [9+.12]
 i 18 + 1 1 [0.7*0/2] [9+.05]
 i 18 + 1 0.5 [0.55*0/2] [9+.09]
 i 18 + 1 0.25 [0.7*0/2] [9+.12]
 i 18 + 1 0.25 [0.65*1/2] [9+.07]
 i 18 + 1 0.75 [0.35*0/2] [9+.09]
 i 18 + 1 3 [0.4*1/2] [9+.00]
}


i 18 + 1 1.5 [0.7*0/2] [9+.09]
 i 18 + 1 0.75 [0.8*0/2] [9+.02]
 i 18 + 1 0.25 [0.7*0/2] [9+.09]
 i 18 + 1 0.25 [0.6*0/2] [9+.12]
 i 18 + 1 0.25 [0.9*1/2] [9+.00]
 ...
 i 18 + 1 3 [0.4*1/2] [9+.00]
 i 18 + 1 1.5 [0.7*0/2] [9+.09]
 i 18 + 1 1 [0.55*0/2] [9+.03]
 i 18 + 1 0.25 [0.7*0/2] [9+.09]
 i 18 + 1 0.25 [0.6*0/2] [9+.12]
 i 18 + 1 0.25 [0.9*1/2] [9+.00]
 i 18 + 1 0.75 [0.35*0/2] [9+.12]
 i 18 + 1 1 [0.7*0/2] [9+.05]
 i 18 + 1 1 [0.95*0/2] [9+.07]
 i 18 + 1 0.25 [0.7*0/2] [9+.12]
 i 18 + 1 0.25 [0.65*1/2] [9+.07]
 i 18 + 1 0.75 [0.35*0/2] [9+.09]
 i 18 + 1 3 [0.4*1/2] [9+.00]
...
{ 5 CNT
i 16 [0+0+$CNT*4*4] 1 1.25 [0.7*0/2] [9+.09]
 i 16 + 1 2.75 [0.5*0/2] [9+.00]
 i 16 + 1 1.25 [0.65*0/2] [9+.00]
 i 16 + 1 2.75 [0.55*1/2] [9+.00]
 i 16 + 1 0.25 [0.6*0/2] [9+.02]
 i 16 + 1 0.5 [0.95*0/2] [9+.02]
 i 16 + 1 0.5 [0.55*1/2] [9+.00]
 i 16 + 1 0.5 [0.75*0/2] [9+.03]
 i 16 + 1 1.5 [0.25*0/2] [9+.00]
 i 16 + 1 0.25 [0.25*0/2] [9+.03]
 i 16 + 1 0.5 [0.95*0/2] [9+.12]
 i 16 + 1 1 [0.2*0/2] [9+.07]
 i 16 + 1 0.25 [0.65*1/2] [9+.00]
 i 16 + 1 1.25 [0.55*0/2] [9+.00]
 i 16 + 1 0.5 [0.5*0/2] [9+.02]
 i 16 + 1 0.25 [0.55*0/2] [9+.03]
}


i 16 + 1 0.5 [0.2*0/2] [9+.12]
 i 16 + 1 2.75 [0.5*0/2] [9+.00]
 i 16 + 1 1.25 [0.65*0/2] [9+.00]
 i 16 + 1 2.75 [0.55*1/2] [9+.00]
 i 16 + 1 0.25 [0.6*0/2] [9+.02]
 ...
 i 16 + 1 0.5 [0.55*1/2] [9+.00]
 i 16 + 1 0.5 [0.75*0/2] [9+.03]
 i 16 + 1 0.75 [0.5*0/2] [9+.07]
 i 16 + 1 0.25 [0.25*0/2] [9+.03]
 i 16 + 1 0.5 [0.95*0/2] [9+.12]
 i 16 + 1 0.5 [0.65*0/2] [9+.02]
 i 16 + 1 0.25 [0.65*1/2] [9+.00]
 i 16 + 1 1.25 [0.55*0/2] [9+.00]
 i 16 + 1 0.5 [0.5*0/2] [9+.02]
 i 16 + 1 2.75 [0.35*1/2] [9+.03]
 ...
 i 16 + 1 0.5 [0.55*1/2] [9+.00]
 i 16 + 1 0.5 [0.75*0/2] [9+.03]
 i 16 + 1 1.25 [0.6*0/2] [9+.00]
 i 16 + 1 0.25 [0.25*0/2] [9+.03]
 i 16 + 1 0.5 [0.95*0/2] [9+.12]
 i 16 + 1 0.5 [0.65*0/2] [9+.02]
 i 16 + 1 1.25 [0.5*0/2] [9+.02]
 i 16 + 1 1.25 [0.55*0/2] [9+.00]
 i 16 + 1 0.5 [0.5*0/2] [9+.02]
 i 16 + 1 0.75 [0.65*0/2] [9+.00]
 i 16 + 1 0.5 [0.2*0/2] [9+.12]
 i 16 + 1 0.25 [0.85*0/2] [9+.07]
 i 16 + 1 1.25 [0.65*0/2] [9+.00]
 i 16 + 1 2.75 [0.55*1/2] [9+.00]
 ...
 i 16 + 1 0.5 [0.75*0/2] [9+.03]
 i 16 + 1 1.25 [0.6*0/2] [9+.00]
 i 16 + 1 1.5 [0.55*0/2] [9+.03]
 i 16 + 1 0.5 [0.95*0/2] [9+.12]
 i 16 + 1 0.5 [0.65*0/2] [9+.02]
 i 16 + 1 1.25 [0.5*0/2] [9+.02]
 i 16 + 1 1.25 [0.55*0/2] [9+.00]
 i 16 + 1 1.5 [0.2*0/2] [9+.09]
 i 16 + 1 0.75 [0.65*0/2] [9+.00]
 i 16 + 1 0.5 [0.2*0/2] [9+.12]
 i 16 + 1 0.25 [0.85*0/2] [9+.07]
 i 16 + 1 1.25 [0.65*0/2] [9+.00]
