...
t 0 310
; lydian tr808 voices=2
b [(6*4*8*1)-4*4*6]

{ 6 CNT
i 8 [0+0+$CNT*4*4] 1 0.75 [0.6*0/2] [7+.00]
 i 8 + 1 0.5 [0.2*0/2] [7+.06]
 i 8 + 1 0.25 [0.65*0/2] [7+.00]
 i 8 + 1 1.5 [0.85*0/2] [7+.00]
 i 8 + 1 0.25 [0.9*0/2] [7+.04]
 i 8 + 1 2.75 [0.5*0/2] [7+.07]
 i 8 + 1 0.25 [0.25*0/2] [7+.00]
 i 8 + 1 1.5 [0.75*0/2] [7+.00]
 i 8 + 1 0.25 [0.85*1/2] [7+.07]
 i 8 + 1 1.25 [0.65*0/2] [7+.00]
 i 8 + 1 0.25 [0.45*1/2] [7+.12]
 i 8 + 1 1.5 [0.75*0/2] [7+.02]
 i 8 + 1 1 [0.2*1/2] [7+.11]
 i 8 + 1 3 [0.8*0/2] [7+.00]
 i 8 + 1 0.5 [0.65*0/2] [7+.00]
 i 8 + 1 3 [0.8*0/2] [7+.00]
}


i 8 + 1 2.75 [0.55*1/2] [7+.09]
 i 8 + 1 3 [0.85*0/2] [7+.00]
 i 8 + 1 0.25 [0.65*0/2] [7+.00]
 i 8 + 1 1.5 [0.85*0/2] [7+.00]
 i 8 + 1 0.25 [0.9*0/2] [7+.04]
 i 8 + 1 2.75 [0.5*0/2] [7+.07]
 i 8 + 1 0.5 [0.4*1/2] [7+.00]
 i 8 + 1 1.5 [0.75*0/2] [7+.00]
 i 8 + 1 0.75 [0.35*0/2] [7+.07]
 i 8 + 1 1.25 [0.65*0/2] [7+.00]
 i 8 + 1 0.25 [0.45*1/2] [7+.12]
 i 8 + 1 1.5 [0.75*0/2] [7+.02]
 i 8 + 1 1 [0.2*1/2] [7+.11]
 ...
 i 8 + 1 1 [0.2*1/2] [7+.11]
 i 8 + 1 3 [0.8*0/2] [7+.00]
 i 8 + 1 0.25 [0.95*0/2] [7+.07]
 i 8 + 1 0.5 [0.95*0/2] [7+.12]
 i 8 [0+0+$CNT*4*4] 1 0.75 [0.6*0/2] [7+.00]
 i 8 + 1 3 [0.85*0/2] [7+.00]
 i 8 + 1 0.5 [0.45*0/2] [7+.12]
 i 8 + 1 1.5 [0.85*0/2] [7+.00]
 i 8 + 1 3 [0.45*1/2] [7+.06]
 i 8 + 1 2.75 [0.5*0/2] [7+.07]
 i 8 + 1 0.5 [0.4*1/2] [7+.00]
 i 8 + 1 1.5 [0.75*0/2] [7+.00]
 i 8 + 1 0.75 [0.35*0/2] [7+.07]
 ...
 i 8 + 1 1.5 [0.75*0/2] [7+.02]
 i 8 + 1 1 [0.2*1/2] [7+.11]
 i 8 + 1 2.75 [0.35*0/2] [7+.00]
 i 8 + 1 0.25 [0.95*0/2] [7+.07]
 i 8 + 1 0.5 [0.95*0/2] [7+.12]
 i 8 [0+0+$CNT*4*4] 1 0.75 [0.6*0/2] [7+.00]
 i 8 + 1 3 [0.85*0/2] [7+.00]
 i 8 + 1 3 [0.95*1/2] [7+.00]
 i 8 + 1 1.5 [0.85*0/2] [7+.00]
 i 8 + 1 3 [0.45*1/2] [7+.06]
 i 8 + 1 2.75 [0.5*0/2] [7+.07]
 i 8 + 1 0.5 [0.4*1/2] [7+.00]
 i 8 + 1 1.5 [0.75*0/2] [7+.00]
 i 8 + 1 0.5 [0.65*0/2] [7+.04]
 i 8 + 1 1.25 [0.65*0/2] [7+.00]
 i 8 + 1 1 [0.85*0/2] [7+.00]
 i 8 + 1 1.5 [0.75*0/2] [7+.02]
 i 8 + 1 1 [0.2*1/2] [7+.11]
 i 8 + 1 2.75 [0.35*0/2] [7+.00]
 i 8 + 1 0.25 [0.95*0/2] [7+.07]
...
{ 6 CNT
i 2 [0+0+$CNT*5*4] 1 0.5 [0.35*0/2] [9+.04]
 i 2 + 1 3 [0.35*0/2] [9+.04]
 i 2 + 1 0.25 [0.95*0/2] [9+.11]
 i 2 + 1 0.5 [0.45*0/2] [9+.11]
 i 2 + 1 1 [0.85*0/2] [9+.02]
 i 2 + 1 0.25 [0.55*0/2] [9+.00]
 i 2 + 1 0.5 [0.85*0/2] [9+.09]
 i 2 + 1 0.5 [0.65*0/2] [9+.06]
 i 2 + 1 1 [0.2*0/2] [9+.06]
 i 2 + 1 0.25 [0.2*0/2] [9+.09]
 i 2 + 1 0.5 [0.45*1/2] [9+.12]
 i 2 + 1 0.5 [0.25*0/2] [9+.06]
 i 2 + 1 1.5 [0.9*1/2] [9+.12]
 i 2 + 1 2.75 [0.3*1/2] [9+.07]
 i 2 + 1 1.5 [0.2*1/2] [9+.09]
 i 2 + 1 1.5 [0.25*0/2] [9+.06]
 i 2 + 1 0.5 [0.6*0/2] [9+.07]
 i 2 + 1 0.25 [0.45*0/2] [9+.09]
 i 2 + 1 2.75 [0.75*0/2] [9+.02]
 i 2 + 1 1.25 [0.55*1/2] [9+.00]
}


i 2 + 1 0.25 [0.85*1/2] [9+.11]
 i 2 + 1 3 [0.35*0/2] [9+.04]
 i 2 + 1 0.25 [0.95*0/2] [9+.11]
 i 2 + 1 3 [0.7*0/2] [9+.00]
 i 2 + 1 1 [0.85*0/2] [9+.02]
 i 2 + 1 0.25 [0.55*0/2] [9+.00]
 i 2 + 1 0.5 [0.85*0/2] [9+.09]
 i 2 + 1 0.5 [0.65*0/2] [9+.06]
 ...
 i 2 + 1 0.5 [0.6*0/2] [9+.07]
 i 2 + 1 0.25 [0.45*0/2] [9+.09]
 i 2 + 1 1 [0.65*0/2] [9+.09]
 i 2 + 1 1.25 [0.55*1/2] [9+.00]
 i 2 + 1 0.25 [0.85*1/2] [9+.11]
 i 2 + 1 0.5 [0.25*1/2] [9+.07]
 i 2 + 1 0.25 [0.95*0/2] [9+.11]
 i 2 + 1 3 [0.7*0/2] [9+.00]
 i 2 + 1 0.75 [0.65*1/2] [9+.00]
 i 2 + 1 0.25 [0.55*0/2] [9+.00]
 i 2 + 1 0.5 [0.85*0/2] [9+.09]
 i 2 + 1 0.5 [0.65*0/2] [9+.06]
 i 2 + 1 1 [0.2*0/2] [9+.06]
