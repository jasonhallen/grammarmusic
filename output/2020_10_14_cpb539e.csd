...
t 0 340
; aeolian emu voices=2
b [(6*4*8*1)-4*4*7]

{ 7 CNT
i 19 [0+0.5+$CNT*4*4] 1 0.25 [0.3*0/2] [6+.00]
 i 19 + 1 2.75 [0.75*1/2] [6+.07]
 i 19 + 1 1.25 [0.4*1/2] [6+.03]
 i 19 + 1 0.5 [0.6*0/2] [6+.00]
 i 19 + 1 0.25 [0.2*1/2] [6+.00]
 i 19 + 1 0.75 [0.9*0/2] [6+.00]
 i 19 + 1 1.25 [0.8*0/2] [6+.08]
 i 19 + 1 1.25 [0.25*0/2] [6+.03]
 i 19 + 1 0.25 [0.5*0/2] [6+.03]
 i 19 + 1 3 [0.8*0/2] [6+.02]
 i 19 + 1 0.75 [0.75*0/2] [6+.00]
 i 19 + 1 0.5 [0.2*0/2] [6+.00]
 i 19 + 1 0.5 [0.9*1/2] [6+.05]
 i 19 + 1 2.75 [0.6*0/2] [6+.00]
 i 19 + 1 0.25 [0.35*0/2] [6+.02]
 i 19 + 1 0.25 [0.8*1/2] [6+.08]
}


i 19 + 1 0.5 [0.55*1/2] [6+.10]
 i 19 + 1 0.25 [0.45*1/2] [6+.12]
 i 19 + 1 1.25 [0.4*1/2] [6+.03]
 i 19 + 1 0.5 [0.6*0/2] [6+.00]
 i 19 + 1 0.25 [0.2*1/2] [6+.00]
 i 19 + 1 0.75 [0.9*0/2] [6+.00]
 ...
 i 19 + 1 0.75 [0.75*0/2] [6+.00]
 i 19 + 1 0.5 [0.2*0/2] [6+.00]
 i 19 + 1 0.25 [0.55*1/2] [6+.12]
 i 19 + 1 2.75 [0.6*0/2] [6+.00]
 i 19 + 1 0.25 [0.35*0/2] [6+.02]
 i 19 + 1 0.25 [0.8*1/2] [6+.08]
 i 19 [0+0.5+$CNT*4*4] 1 0.25 [0.3*0/2] [6+.00]
 i 19 + 1 1.25 [0.2*1/2] [6+.05]
 i 19 + 1 1.25 [0.4*1/2] [6+.03]
 i 19 + 1 0.5 [0.6*0/2] [6+.00]
 i 19 + 1 0.25 [0.2*1/2] [6+.00]
 i 19 + 1 0.75 [0.9*0/2] [6+.00]
 ...
 i 19 + 1 0.25 [0.55*1/2] [6+.12]
 i 19 + 1 2.75 [0.6*0/2] [6+.00]
 i 19 + 1 0.25 [0.75*1/2] [6+.02]
 i 19 + 1 0.25 [0.8*1/2] [6+.08]
 i 19 [0+0.5+$CNT*4*4] 1 0.25 [0.3*0/2] [6+.00]
 i 19 + 1 1.25 [0.2*1/2] [6+.05]
 i 19 + 1 1.25 [0.4*1/2] [6+.03]
 i 19 + 1 0.25 [0.9*0/2] [6+.00]
 i 19 + 1 0.25 [0.2*1/2] [6+.00]
 i 19 + 1 1.5 [0.6*1/2] [6+.02]
 i 19 + 1 1.25 [0.8*0/2] [6+.08]
 i 19 + 1 1.25 [0.25*0/2] [6+.03]
...
{ 8 CNT
i 17 [0+0+$CNT*4*4] 1 1.5 [0.35*0/2] [6+.00]
 i 17 + 1 0.5 [0.45*0/2] [6+.00]
 i 17 + 1 2.75 [0.55*0/2] [6+.03]
 i 17 + 1 0.5 [0.5*0/2] [6+.05]
 i 17 + 1 0.25 [0.45*1/2] [6+.03]
 i 17 + 1 0.25 [0.45*1/2] [6+.00]
 i 17 + 1 0.5 [0.6*1/2] [6+.02]
 i 17 + 1 0.25 [0.5*0/2] [6+.05]
 i 17 + 1 1 [0.65*0/2] [6+.00]
 i 17 + 1 1.25 [0.6*0/2] [6+.12]
 i 17 + 1 0.5 [0.4*0/2] [6+.02]
 i 17 + 1 0.5 [0.35*0/2] [6+.02]
 i 17 + 1 0.5 [0.85*0/2] [6+.10]
 i 17 + 1 0.25 [0.2*1/2] [6+.08]
 i 17 + 1 0.5 [0.25*0/2] [6+.10]
 i 17 + 1 0.5 [0.7*0/2] [6+.00]
}


i 17 + 1 1.5 [0.3*0/2] [6+.05]
 i 17 + 1 0.5 [0.45*0/2] [6+.00]
 i 17 + 1 2.75 [0.55*0/2] [6+.03]
 i 17 + 1 0.5 [0.5*0/2] [6+.05]
 i 17 + 1 0.25 [0.45*1/2] [6+.03]
 ...
 i 17 + 1 0.5 [0.6*1/2] [6+.02]
 i 17 + 1 0.25 [0.5*0/2] [6+.05]
 i 17 + 1 0.75 [0.3*0/2] [6+.07]
 i 17 + 1 2.75 [0.45*0/2] [6+.07]
 i 17 + 1 0.5 [0.4*0/2] [6+.02]
 i 17 + 1 0.5 [0.35*0/2] [6+.02]
 i 17 + 1 0.5 [0.85*0/2] [6+.10]
 i 17 + 1 1.25 [0.95*0/2] [6+.00]
 i 17 + 1 2.75 [0.75*1/2] [6+.08]
 i 17 + 1 0.75 [0.25*1/2] [6+.00]
 i 17 + 1 1.5 [0.3*0/2] [6+.05]
 i 17 + 1 0.5 [0.45*0/2] [6+.00]
 i 17 + 1 1 [0.45*1/2] [6+.05]
 i 17 + 1 0.5 [0.5*0/2] [6+.05]
