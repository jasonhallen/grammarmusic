...
{ 7 CNT
i 12 [0+0.5+$CNT*6*4] 1 0.5 [0.55*0/2] [7+.10]
 i 12 + 1 1.5 [0.9*0/2] [7+.07]
 i 12 + 1 0.5 [0.95*0/2] [7+.10]
 i 12 + 1 2.75 [0.8*0/2] [7+.00]
 i 12 + 1 0.75 [0.85*0/2] [7+.01]
 i 12 + 1 0.5 [0.35*0/2] [7+.12]
 i 12 + 1 0.25 [0.75*0/2] [7+.11]
 i 12 + 1 0.5 [0.8*0/2] [7+.06]
 i 12 + 1 0.25 [0.5*0/2] [7+.09]
 i 12 + 1 0.25 [0.4*0/2] [7+.01]
 i 12 + 1 1.25 [0.4*1/2] [7+.12]
 i 12 + 1 0.25 [0.45*0/2] [7+.12]
 i 12 + 1 0.25 [0.95*0/2] [7+.11]
 i 12 + 1 0.5 [0.7*0/2] [7+.04]
 i 12 + 1 0.25 [0.9*1/2] [7+.01]
 i 12 + 1 0.25 [0.55*0/2] [7+.08]
 i 12 + 1 0.25 [0.25*0/2] [7+.01]
 i 12 + 1 1 [0.85*1/2] [7+.09]
 i 12 + 1 2.75 [0.9*0/2] [7+.01]
 i 12 + 1 0.75 [0.8*0/2] [7+.10]
 i 12 + 1 0.5 [0.6*0/2] [7+.11]
 i 12 + 1 0.25 [0.55*1/2] [7+.03]
 i 12 + 1 0.5 [0.3*0/2] [7+.06]
 i 12 + 1 0.5 [0.7*1/2] [7+.00]
}


i 12 + 1 0.25 [0.9*1/2] [7+.02]
 i 12 + 1 1.5 [0.9*0/2] [7+.07]
 i 12 + 1 0.25 [0.75*0/2] [7+.11]
 i 12 + 1 2.75 [0.8*0/2] [7+.00]
 i 12 + 1 0.75 [0.85*0/2] [7+.01]
 ...
 i 12 + 1 0.25 [0.95*0/2] [7+.11]
 i 12 + 1 0.5 [0.7*0/2] [7+.04]
 i 12 + 1 0.75 [0.25*0/2] [7+.05]
 i 12 + 1 0.25 [0.55*0/2] [7+.08]
 i 12 + 1 0.25 [0.25*0/2] [7+.01]
 i 12 + 1 1 [0.85*1/2] [7+.09]
 i 12 + 1 0.25 [0.3*1/2] [7+.05]
 i 12 + 1 0.75 [0.8*0/2] [7+.10]
 i 12 + 1 0.5 [0.6*0/2] [7+.11]
 i 12 + 1 0.25 [0.55*1/2] [7+.03]
 i 12 + 1 0.5 [0.3*0/2] [7+.06]
 ...
 i 12 + 1 0.25 [0.95*0/2] [7+.11]
 i 12 + 1 0.5 [0.7*0/2] [7+.04]
 i 12 + 1 0.5 [0.2*0/2] [7+.04]
 i 12 + 1 0.5 [0.3*1/2] [7+.06]
 i 12 + 1 0.5 [0.4*0/2] [7+.03]
 i 12 + 1 1 [0.85*1/2] [7+.09]
 i 12 + 1 0.25 [0.3*1/2] [7+.05]
 i 12 + 1 0.75 [0.8*0/2] [7+.10]
 i 12 + 1 0.5 [0.6*0/2] [7+.11]
 ...
 i 12 + 1 0.75 [0.8*0/2] [7+.10]
 i 12 + 1 0.5 [0.6*0/2] [7+.11]
 i 12 + 1 0.5 [0.95*0/2] [7+.08]
 i 12 + 1 0.5 [0.3*0/2] [7+.06]
 i 12 + 1 0.5 [0.7*1/2] [7+.00]
 i 12 [0+0.5+$CNT*6*4] 1 0.5 [0.55*0/2] [7+.10]
 i 12 + 1 1 [0.6*0/2] [7+.01]
 i 12 + 1 0.25 [0.75*0/2] [7+.11]
 i 12 + 1 1 [0.3*1/2] [7+.06]
 i 12 + 1 0.75 [0.85*0/2] [7+.01]
 i 12 + 1 0.5 [0.35*0/2] [7+.12]
...
{ 7 CNT
i 11 [0+0+$CNT*3*4] 1 2.75 [0.25*0/2] [7+.02]
 i 11 + 1 0.75 [0.8*0/2] [7+.12]
 i 11 + 1 0.5 [0.35*1/2] [7+.11]
 i 11 + 1 0.5 [0.65*0/2] [7+.08]
 i 11 + 1 2.75 [0.85*0/2] [7+.05]
 i 11 + 1 1 [0.4*1/2] [7+.09]
 i 11 + 1 0.25 [0.8*0/2] [7+.09]
 i 11 + 1 0.5 [0.2*0/2] [7+.02]
 i 11 + 1 0.5 [0.6*1/2] [7+.10]
 i 11 + 1 0.25 [0.8*0/2] [7+.04]
 i 11 + 1 3 [0.25*0/2] [7+.07]
 i 11 + 1 0.25 [0.35*0/2] [7+.01]
}


i 11 + 1 0.75 [0.7*0/2] [7+.07]
 i 11 + 1 0.5 [0.65*1/2] [7+.07]
 i 11 + 1 0.5 [0.35*1/2] [7+.11]
 i 11 + 1 0.5 [0.65*0/2] [7+.08]
 i 11 + 1 2.75 [0.85*0/2] [7+.05]
 i 11 + 1 1 [0.4*1/2] [7+.09]
