...
t 0 260
; phrygian tr808 voices=1
b [(6*4*8*1)-3*4*7]

{ 7 CNT
i 1 [0+0.5+$CNT*3*4] 1 1.5 [0.75*0/1] [8+.00]
 i 1 + 1 0.5 [0.45*1/1] [8+.07]
 i 1 + 1 0.5 [0.8*0/1] [8+.10]
 i 1 + 1 0.75 [0.6*0/1] [8+.00]
 i 1 + 1 2.75 [0.65*1/1] [8+.00]
 i 1 + 1 0.5 [0.2*1/1] [8+.05]
 i 1 + 1 3 [0.25*0/1] [8+.01]
 i 1 + 1 0.5 [0.85*0/1] [8+.05]
 i 1 + 1 0.25 [0.4*0/1] [8+.00]
 i 1 + 1 1 [0.6*0/1] [8+.00]
 i 1 + 1 1.5 [0.9*1/1] [8+.01]
 i 1 + 1 2.75 [0.45*0/1] [8+.12]
}


i 1 + 1 1 [0.3*0/1] [8+.05]
 i 1 + 1 0.5 [0.45*1/1] [8+.07]
 i 1 + 1 0.5 [0.8*0/1] [8+.10]
 i 1 + 1 0.75 [0.6*0/1] [8+.00]
 i 1 + 1 2.75 [0.65*1/1] [8+.00]
 ...
 i 1 + 1 0.5 [0.8*0/1] [8+.10]
 i 1 + 1 0.75 [0.6*0/1] [8+.00]
 i 1 + 1 0.75 [0.6*0/1] [8+.08]
 i 1 + 1 0.5 [0.2*1/1] [8+.05]
 i 1 + 1 3 [0.25*0/1] [8+.01]
 i 1 + 1 0.5 [0.85*0/1] [8+.05]
 i 1 + 1 0.25 [0.95*0/1] [8+.05]
 i 1 + 1 0.25 [0.65*1/1] [8+.05]
 i 1 + 1 1.5 [0.9*1/1] [8+.01]
 i 1 + 1 2.75 [0.45*0/1] [8+.12]
 i 1 + 1 1 [0.3*0/1] [8+.05]
 i 1 + 1 0.5 [0.45*1/1] [8+.07]
 ...
 i 1 + 1 0.75 [0.6*0/1] [8+.08]
 i 1 + 1 0.5 [0.2*1/1] [8+.05]
 i 1 + 1 1.25 [0.4*0/1] [8+.05]
 i 1 + 1 0.5 [0.85*0/1] [8+.05]
 i 1 + 1 0.5 [0.9*0/1] [8+.07]
 i 1 + 1 0.25 [0.65*1/1] [8+.05]
 i 1 + 1 0.25 [0.25*1/1] [8+.01]
 i 1 + 1 2.75 [0.45*0/1] [8+.12]
