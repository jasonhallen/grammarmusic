...
{ 5 CNT
i 11 [0+0+$CNT*3*4] 1 1.5 [0.6*1/2] [9+.00]
 i 11 + 1 1.5 [0.2*0/2] [9+.00]
 i 11 + 1 0.75 [0.55*0/2] [9+.04]
 i 11 + 1 0.25 [0.4*0/2] [9+.07]
 i 11 + 1 0.5 [0.35*0/2] [9+.11]
 i 11 + 1 2.75 [0.7*0/2] [9+.07]
 i 11 + 1 3 [0.75*1/2] [9+.11]
 i 11 + 1 2.75 [0.85*0/2] [9+.05]
 i 11 + 1 0.5 [0.9*1/2] [9+.00]
 i 11 + 1 0.25 [0.75*1/2] [9+.04]
 i 11 + 1 0.25 [0.95*0/2] [9+.00]
 i 11 + 1 1.5 [0.7*0/2] [9+.05]
}


i 11 + 1 0.25 [0.35*0/2] [9+.00]
 i 11 + 1 1.5 [0.2*0/2] [9+.00]
 i 11 + 1 0.75 [0.55*0/2] [9+.04]
 i 11 + 1 0.25 [0.4*0/2] [9+.07]
 i 11 + 1 0.5 [0.35*0/2] [9+.11]
...
{ 7 CNT
i 5 [0+0+$CNT*6*4] 1 3 [0.9*0/2] [8+.07]
 i 5 + 1 0.25 [0.95*0/2] [8+.00]
 i 5 + 1 2.75 [0.2*1/2] [8+.00]
 i 5 + 1 0.25 [0.2*0/2] [8+.00]
 i 5 + 1 0.5 [0.25*1/2] [8+.00]
 i 5 + 1 3 [0.3*1/2] [8+.07]
 i 5 + 1 0.25 [0.25*0/2] [8+.11]
 i 5 + 1 0.75 [0.55*0/2] [8+.07]
 i 5 + 1 0.5 [0.55*0/2] [8+.12]
 i 5 + 1 0.5 [0.65*1/2] [8+.04]
 i 5 + 1 1.5 [0.75*0/2] [8+.00]
 i 5 + 1 0.5 [0.9*0/2] [8+.04]
 i 5 + 1 0.5 [0.25*0/2] [8+.11]
 i 5 + 1 2.75 [0.9*1/2] [8+.02]
 i 5 + 1 0.25 [0.7*0/2] [8+.00]
 i 5 + 1 0.5 [0.3*0/2] [8+.00]
 i 5 + 1 0.75 [0.45*0/2] [8+.11]
 i 5 + 1 1.5 [0.95*0/2] [8+.11]
 i 5 + 1 0.5 [0.7*1/2] [8+.11]
 i 5 + 1 0.25 [0.55*1/2] [8+.00]
 i 5 + 1 0.25 [0.85*0/2] [8+.09]
 i 5 + 1 0.5 [0.8*0/2] [8+.00]
 i 5 + 1 1 [0.25*0/2] [8+.07]
 i 5 + 1 0.5 [0.2*0/2] [8+.12]
}


i 5 + 1 0.5 [0.8*1/2] [8+.02]
 i 5 + 1 0.25 [0.95*0/2] [8+.00]
 i 5 + 1 2.75 [0.2*1/2] [8+.00]
 i 5 + 1 0.25 [0.2*0/2] [8+.00]
 i 5 + 1 0.5 [0.25*1/2] [8+.00]
 ...
 i 5 + 1 0.5 [0.2*0/2] [8+.12]
 i 5 + 1 0.5 [0.8*1/2] [8+.02]
 i 5 + 1 0.5 [0.85*0/2] [8+.12]
 i 5 + 1 2.75 [0.2*1/2] [8+.00]
 i 5 + 1 0.25 [0.2*0/2] [8+.00]
 i 5 + 1 0.5 [0.25*1/2] [8+.00]
 i 5 + 1 1.5 [0.4*0/2] [8+.00]
 i 5 + 1 0.25 [0.25*0/2] [8+.11]
 i 5 + 1 0.75 [0.55*0/2] [8+.07]
 i 5 + 1 0.5 [0.4*0/2] [8+.09]
 i 5 + 1 0.5 [0.65*1/2] [8+.04]
 ...
 i 5 + 1 0.5 [0.4*0/2] [8+.09]
 i 5 + 1 0.5 [0.65*1/2] [8+.04]
 i 5 + 1 3 [0.3*0/2] [8+.02]
 i 5 + 1 0.5 [0.9*0/2] [8+.04]
 i 5 + 1 0.5 [0.25*0/2] [8+.11]
 i 5 + 1 2.75 [0.9*1/2] [8+.02]
 i 5 + 1 0.25 [0.7*0/2] [8+.00]
 i 5 + 1 0.5 [0.3*0/2] [8+.00]
 i 5 + 1 0.25 [0.25*0/2] [8+.12]
 i 5 + 1 0.25 [0.45*0/2] [8+.11]
 i 5 + 1 0.5 [0.7*1/2] [8+.11]
 i 5 + 1 0.25 [0.55*1/2] [8+.00]
 i 5 + 1 0.25 [0.85*0/2] [8+.09]
 ...
 i 5 + 1 0.5 [0.8*1/2] [8+.02]
 i 5 + 1 0.5 [0.85*0/2] [8+.12]
 i 5 + 1 1.5 [0.25*0/2] [8+.05]
 i 5 + 1 0.25 [0.2*0/2] [8+.00]
 i 5 + 1 0.5 [0.25*1/2] [8+.00]
 i 5 + 1 1.5 [0.5*1/2] [8+.05]
 i 5 + 1 0.25 [0.25*0/2] [8+.11]
 i 5 + 1 0.75 [0.55*0/2] [8+.07]
 i 5 + 1 0.5 [0.4*0/2] [8+.09]
 i 5 + 1 0.5 [0.65*1/2] [8+.04]
 ...
 i 5 + 1 0.5 [0.8*1/2] [8+.02]
 i 5 + 1 0.5 [0.85*0/2] [8+.12]
 i 5 + 1 1 [0.2*0/2] [8+.02]
 i 5 + 1 0.25 [0.9*1/2] [8+.04]
 i 5 + 1 0.5 [0.25*1/2] [8+.00]
 i 5 + 1 1.5 [0.5*1/2] [8+.05]
 i 5 + 1 0.25 [0.25*0/2] [8+.11]
 i 5 + 1 0.75 [0.55*0/2] [8+.07]
