...
t 0 400
; aeolian tr808 voices=1
b [(6*4*8*1)-5*4*5]

{ 5 CNT
i 2 [0+0.5+$CNT*5*4] 1 3 [0.9*1/1] [7+.08]
 i 2 + 1 3 [0.75*0/1] [7+.00]
 i 2 + 1 2.75 [0.75*0/1] [7+.00]
 i 2 + 1 1.5 [0.8*0/1] [7+.00]
 i 2 + 1 3 [0.8*0/1] [7+.05]
 i 2 + 1 1.5 [0.65*0/1] [7+.03]
 i 2 + 1 3 [0.85*0/1] [7+.08]
 i 2 + 1 1.5 [0.3*0/1] [7+.00]
 i 2 + 1 0.25 [0.45*0/1] [7+.02]
 i 2 + 1 0.75 [0.8*0/1] [7+.07]
 i 2 + 1 1 [0.35*0/1] [7+.00]
 i 2 + 1 0.5 [0.75*1/1] [7+.07]
 i 2 + 1 0.5 [0.65*0/1] [7+.07]
 i 2 + 1 3 [0.2*0/1] [7+.00]
 i 2 + 1 0.5 [0.65*0/1] [7+.03]
 i 2 + 1 0.5 [0.7*0/1] [7+.07]
 i 2 + 1 1.5 [0.25*0/1] [7+.08]
 i 2 + 1 1 [0.5*0/1] [7+.02]
 i 2 + 1 1.5 [0.2*0/1] [7+.03]
 i 2 + 1 1 [0.4*0/1] [7+.02]
}


i 2 + 1 1.25 [0.2*0/1] [7+.02]
 i 2 + 1 3 [0.75*0/1] [7+.00]
 i 2 + 1 2.75 [0.75*0/1] [7+.00]
 i 2 + 1 1.5 [0.8*0/1] [7+.00]
 i 2 + 1 3 [0.8*0/1] [7+.05]
