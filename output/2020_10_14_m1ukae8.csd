...
t 0 400
; mixolydian emu voices=1
b [(6*4*8*1)-6*4*7]

{ 7 CNT
i 14 [0+0.5+$CNT*6*4] 1 0.5 [0.85*0/1] [6+.09]
 i 14 + 1 0.5 [0.3*0/1] [6+.04]
 i 14 + 1 2.75 [0.45*1/1] [6+.00]
 i 14 + 1 0.5 [0.85*0/1] [6+.10]
 i 14 + 1 0.75 [0.25*1/1] [6+.02]
 i 14 + 1 2.75 [0.45*0/1] [6+.00]
 i 14 + 1 1.25 [0.25*0/1] [6+.10]
 i 14 + 1 1.25 [0.6*0/1] [6+.00]
 i 14 + 1 0.25 [0.2*0/1] [6+.00]
 i 14 + 1 0.75 [0.5*0/1] [6+.00]
 i 14 + 1 0.5 [0.95*0/1] [6+.12]
 i 14 + 1 0.25 [0.2*0/1] [6+.00]
 i 14 + 1 0.25 [0.55*0/1] [6+.05]
 i 14 + 1 1.25 [0.85*0/1] [6+.12]
 i 14 + 1 0.25 [0.8*0/1] [6+.05]
 i 14 + 1 2.75 [0.2*1/1] [6+.00]
 i 14 + 1 1.5 [0.4*0/1] [6+.00]
 i 14 + 1 0.25 [0.8*0/1] [6+.02]
 i 14 + 1 2.75 [0.9*0/1] [6+.00]
 i 14 + 1 0.25 [0.5*1/1] [6+.02]
 i 14 + 1 3 [0.9*0/1] [6+.12]
 i 14 + 1 0.5 [0.95*1/1] [6+.00]
 i 14 + 1 0.25 [0.4*0/1] [6+.02]
 i 14 + 1 1.25 [0.85*1/1] [6+.07]
}


i 14 + 1 3 [0.8*0/1] [6+.12]
 i 14 + 1 0.5 [0.3*0/1] [6+.04]
 i 14 + 1 2.75 [0.45*1/1] [6+.00]
 i 14 + 1 0.5 [0.85*0/1] [6+.10]
 i 14 + 1 0.5 [0.4*0/1] [6+.05]
 i 14 + 1 2.75 [0.45*0/1] [6+.00]
 i 14 + 1 1.25 [0.25*0/1] [6+.10]
 i 14 + 1 1.25 [0.6*0/1] [6+.00]
 i 14 + 1 0.25 [0.2*0/1] [6+.00]
 i 14 + 1 0.75 [0.5*0/1] [6+.00]
 i 14 + 1 3 [0.4*0/1] [6+.10]
 i 14 + 1 0.25 [0.2*0/1] [6+.00]
 i 14 + 1 0.25 [0.55*0/1] [6+.05]
 i 14 + 1 1.25 [0.85*0/1] [6+.12]
 i 14 + 1 0.25 [0.8*0/1] [6+.05]
 ...
 i 14 + 1 1.25 [0.6*0/1] [6+.00]
 i 14 + 1 1.25 [0.55*1/1] [6+.02]
 i 14 + 1 0.5 [0.55*1/1] [6+.05]
 i 14 + 1 3 [0.4*0/1] [6+.10]
 i 14 + 1 0.5 [0.3*1/1] [6+.00]
 i 14 + 1 0.25 [0.55*0/1] [6+.05]
 i 14 + 1 1.25 [0.85*0/1] [6+.12]
 i 14 + 1 1.5 [0.7*0/1] [6+.02]
 i 14 + 1 2.75 [0.2*1/1] [6+.00]
 i 14 + 1 1.5 [0.4*0/1] [6+.00]
 i 14 + 1 0.25 [0.8*0/1] [6+.02]
 i 14 + 1 0.25 [0.55*0/1] [6+.04]
