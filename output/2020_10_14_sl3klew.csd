...
{ 7 CNT
i 17 [0+0.5+$CNT*3*4] 1 2.75 [0.5*0/2] [9+.00]
 i 17 + 1 1 [0.95*0/2] [9+.05]
 i 17 + 1 0.5 [0.4*0/2] [9+.05]
 i 17 + 1 0.75 [0.35*1/2] [9+.12]
 i 17 + 1 0.75 [0.45*0/2] [9+.00]
 i 17 + 1 0.5 [0.55*0/2] [9+.07]
 i 17 + 1 0.25 [0.45*1/2] [9+.00]
 i 17 + 1 0.5 [0.75*0/2] [9+.00]
 i 17 + 1 0.75 [0.45*0/2] [9+.04]
 i 17 + 1 3 [0.7*1/2] [9+.00]
 i 17 + 1 0.5 [0.45*0/2] [9+.07]
 i 17 + 1 1.25 [0.45*1/2] [9+.05]
}


i 17 + 1 0.25 [0.35*0/2] [9+.04]
 i 17 + 1 1 [0.95*0/2] [9+.05]
 i 17 + 1 0.5 [0.4*0/2] [9+.05]
 i 17 + 1 0.75 [0.35*1/2] [9+.12]
 i 17 + 1 0.75 [0.45*0/2] [9+.00]
 ...
 i 17 + 1 0.25 [0.45*1/2] [9+.00]
 i 17 + 1 0.5 [0.75*0/2] [9+.00]
 i 17 + 1 0.5 [0.45*0/2] [9+.09]
 i 17 + 1 3 [0.7*1/2] [9+.00]
 i 17 + 1 1 [0.25*0/2] [9+.12]
 i 17 + 1 1.25 [0.45*1/2] [9+.05]
 i 17 + 1 0.25 [0.35*0/2] [9+.04]
 i 17 + 1 1 [0.95*0/2] [9+.05]
 i 17 + 1 0.5 [0.4*0/2] [9+.05]
 ...
 i 17 + 1 1.25 [0.7*1/2] [9+.07]
 i 17 + 1 0.5 [0.75*0/2] [9+.00]
 i 17 + 1 0.25 [0.2*0/2] [9+.00]
 i 17 + 1 1 [0.35*1/2] [9+.02]
 i 17 + 1 3 [0.8*0/2] [9+.04]
 i 17 + 1 1.25 [0.45*1/2] [9+.05]
 i 17 + 1 0.25 [0.35*0/2] [9+.04]
 i 17 + 1 0.5 [0.35*0/2] [9+.04]
...
{ 8 CNT
i 22 [0+0+$CNT*3*4] 1 0.25 [0.3*0/2] [8+.00]
 i 22 + 1 1.25 [0.5*0/2] [8+.02]
 i 22 + 1 0.5 [0.8*1/2] [8+.00]
 i 22 + 1 0.5 [0.35*0/2] [8+.02]
 i 22 + 1 0.75 [0.75*0/2] [8+.04]
 i 22 + 1 3 [0.35*1/2] [8+.04]
 i 22 + 1 0.5 [0.4*1/2] [8+.02]
 i 22 + 1 0.75 [0.7*1/2] [8+.07]
 i 22 + 1 0.5 [0.2*0/2] [8+.00]
 i 22 + 1 0.5 [0.55*1/2] [8+.07]
 i 22 + 1 1 [0.95*0/2] [8+.00]
 i 22 + 1 1 [0.8*0/2] [8+.00]
}


i 22 + 1 0.25 [0.65*0/2] [8+.04]
 i 22 + 1 1.25 [0.5*0/2] [8+.02]
 i 22 + 1 0.5 [0.8*1/2] [8+.00]
 i 22 + 1 0.5 [0.35*0/2] [8+.02]
 i 22 + 1 0.75 [0.75*0/2] [8+.04]
 ...
 i 22 + 1 1.25 [0.5*0/2] [8+.02]
 i 22 + 1 0.5 [0.8*1/2] [8+.00]
 i 22 + 1 0.25 [0.85*0/2] [8+.00]
 i 22 + 1 0.75 [0.75*0/2] [8+.04]
 i 22 + 1 3 [0.35*1/2] [8+.04]
 i 22 + 1 0.5 [0.4*1/2] [8+.02]
 i 22 + 1 0.75 [0.7*1/2] [8+.07]
 i 22 + 1 1.5 [0.7*0/2] [8+.09]
 i 22 + 1 0.5 [0.55*1/2] [8+.07]
 i 22 + 1 1.5 [0.75*1/2] [8+.00]
 i 22 + 1 1 [0.8*0/2] [8+.00]
 i 22 [0+0+$CNT*3*4] 1 0.25 [0.3*0/2] [8+.00]
