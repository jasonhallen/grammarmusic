...
{ 5 CNT
i 17 [0+0+$CNT*4*4] 1 0.25 [0.4*0/2] [9+.02]
 i 17 + 1 1.25 [0.5*0/2] [9+.01]
 i 17 + 1 0.5 [0.35*1/2] [9+.09]
 i 17 + 1 1.5 [0.65*1/2] [9+.04]
 i 17 + 1 0.25 [0.65*1/2] [9+.10]
 i 17 + 1 2.75 [0.65*0/2] [9+.04]
 i 17 + 1 1 [0.3*0/2] [9+.05]
 i 17 + 1 0.25 [0.3*0/2] [9+.02]
 i 17 + 1 1.25 [0.6*0/2] [9+.02]
 i 17 + 1 1 [0.4*1/2] [9+.00]
 i 17 + 1 1.25 [0.65*0/2] [9+.04]
 i 17 + 1 0.25 [0.6*0/2] [9+.06]
 i 17 + 1 1 [0.85*0/2] [9+.01]
 i 17 + 1 0.25 [0.7*1/2] [9+.02]
 i 17 + 1 1.25 [0.8*0/2] [9+.05]
 i 17 + 1 0.25 [0.6*1/2] [9+.05]
}


i 17 + 1 3 [0.55*0/2] [9+.11]
 i 17 + 1 1.25 [0.5*0/2] [9+.01]
 i 17 + 1 0.5 [0.35*1/2] [9+.09]
 i 17 + 1 0.75 [0.9*1/2] [9+.12]
 i 17 + 1 0.25 [0.65*1/2] [9+.10]
 i 17 + 1 2.75 [0.65*0/2] [9+.04]
 i 17 + 1 1 [0.3*0/2] [9+.05]
 i 17 + 1 0.25 [0.3*0/2] [9+.02]
 ...
 i 17 + 1 0.25 [0.7*1/2] [9+.02]
 i 17 + 1 1.25 [0.8*0/2] [9+.05]
 i 17 + 1 1 [0.85*1/2] [9+.02]
 i 17 + 1 3 [0.55*0/2] [9+.11]
 i 17 + 1 1.25 [0.5*0/2] [9+.01]
 i 17 + 1 0.25 [0.9*0/2] [9+.09]
 i 17 + 1 0.75 [0.9*1/2] [9+.12]
 i 17 + 1 0.25 [0.65*1/2] [9+.10]
 i 17 + 1 2.75 [0.65*0/2] [9+.04]
 i 17 + 1 1 [0.3*0/2] [9+.05]
...
{ 8 CNT
i 1 [0+0+$CNT*5*4] 1 1 [0.6*0/2] [9+.12]
 i 1 + 1 0.25 [0.35*1/2] [9+.01]
 i 1 + 1 0.75 [0.8*0/2] [9+.00]
 i 1 + 1 0.5 [0.75*0/2] [9+.05]
 i 1 + 1 3 [0.5*0/2] [9+.01]
 i 1 + 1 0.5 [0.5*0/2] [9+.04]
 i 1 + 1 2.75 [0.2*0/2] [9+.10]
 i 1 + 1 0.5 [0.75*0/2] [9+.02]
 i 1 + 1 0.25 [0.25*0/2] [9+.11]
 i 1 + 1 0.5 [0.5*1/2] [9+.03]
 i 1 + 1 0.5 [0.65*0/2] [9+.05]
 i 1 + 1 0.25 [0.55*1/2] [9+.04]
 i 1 + 1 0.5 [0.5*0/2] [9+.00]
 i 1 + 1 2.75 [0.45*1/2] [9+.08]
 i 1 + 1 1 [0.35*0/2] [9+.12]
 i 1 + 1 2.75 [0.8*0/2] [9+.00]
 i 1 + 1 0.25 [0.85*0/2] [9+.06]
 i 1 + 1 0.25 [0.95*0/2] [9+.09]
 i 1 + 1 0.75 [0.4*0/2] [9+.10]
 i 1 + 1 0.5 [0.3*1/2] [9+.07]
}


i 1 + 1 1.25 [0.25*0/2] [9+.04]
 i 1 + 1 0.25 [0.35*1/2] [9+.01]
 i 1 + 1 0.75 [0.8*0/2] [9+.00]
 i 1 + 1 0.5 [0.75*0/2] [9+.05]
 i 1 + 1 3 [0.5*0/2] [9+.01]
 ...
 i 1 + 1 1 [0.35*0/2] [9+.12]
 i 1 + 1 2.75 [0.8*0/2] [9+.00]
 i 1 + 1 3 [0.45*0/2] [9+.04]
 i 1 + 1 1 [0.95*0/2] [9+.04]
 i 1 + 1 0.75 [0.4*0/2] [9+.10]
 i 1 + 1 0.5 [0.3*1/2] [9+.07]
 i 1 [0+0+$CNT*5*4] 1 1 [0.6*0/2] [9+.12]
 i 1 + 1 0.25 [0.35*1/2] [9+.01]
 ...
 i 1 + 1 0.25 [0.2*0/2] [9+.11]
 i 1 + 1 1.25 [0.95*0/2] [9+.06]
 i 1 + 1 1.5 [0.6*1/2] [9+.00]
 i 1 + 1 0.25 [0.55*1/2] [9+.04]
 i 1 + 1 0.5 [0.5*0/2] [9+.00]
 i 1 + 1 2.75 [0.45*1/2] [9+.08]
 i 1 + 1 0.5 [0.55*0/2] [9+.00]
 i 1 + 1 2.75 [0.8*0/2] [9+.00]
 i 1 + 1 3 [0.45*0/2] [9+.04]
 i 1 + 1 1 [0.95*0/2] [9+.04]
 i 1 + 1 0.75 [0.4*0/2] [9+.10]
 i 1 + 1 0.75 [0.9*0/2] [9+.00]
 i 1 [0+0+$CNT*5*4] 1 1 [0.6*0/2] [9+.12]
 i 1 + 1 0.25 [0.35*1/2] [9+.01]
 i 1 + 1 0.75 [0.8*0/2] [9+.00]
 i 1 + 1 0.5 [0.75*0/2] [9+.05]
