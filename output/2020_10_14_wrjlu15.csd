...
; aeolian emu voices=1
t 0 380
b [(6*4*8*1)-4*4*7]

{ 7 CNT
i 21 [0+0+$CNT*4*4] 1 1.5 [0.65*0/1] [8+.03]
 i 21 + 1 0.5 [0.5*0/1] [8+.05]
 i 21 + 1 0.5 [0.25*0/1] [8+.00]
 i 21 + 1 3 [0.95*0/1] [8+.00]
 i 21 + 1 0.5 [0.5*0/1] [8+.07]
 i 21 + 1 0.25 [0.4*0/1] [8+.02]
 i 21 + 1 1 [0.75*0/1] [8+.10]
 i 21 + 1 2.75 [0.55*0/1] [8+.12]
 i 21 + 1 0.5 [0.65*0/1] [8+.10]
 i 21 + 1 0.5 [0.7*1/1] [8+.10]
 i 21 + 1 0.75 [0.85*0/1] [8+.12]
 i 21 + 1 0.5 [0.35*0/1] [8+.12]
 i 21 + 1 0.75 [0.65*0/1] [8+.00]
 i 21 + 1 0.5 [0.2*0/1] [8+.05]
 i 21 + 1 0.5 [0.8*0/1] [8+.08]
 i 21 + 1 1.25 [0.75*1/1] [8+.00]
}


i 21 + 1 3 [0.85*0/1] [8+.10]
 i 21 + 1 0.5 [0.5*0/1] [8+.05]
 i 21 + 1 0.5 [0.25*0/1] [8+.00]
 i 21 + 1 3 [0.95*0/1] [8+.00]
 i 21 + 1 0.5 [0.5*0/1] [8+.07]
 ...
 i 21 + 1 0.25 [0.4*0/1] [8+.02]
 i 21 + 1 1 [0.75*0/1] [8+.10]
 i 21 + 1 0.5 [0.6*0/1] [8+.12]
 i 21 + 1 0.5 [0.65*0/1] [8+.10]
 i 21 + 1 2.75 [0.85*1/1] [8+.03]
 i 21 + 1 0.75 [0.85*0/1] [8+.12]
 i 21 + 1 0.5 [0.35*0/1] [8+.12]
 i 21 + 1 0.75 [0.65*0/1] [8+.00]
 i 21 + 1 1.5 [0.75*0/1] [8+.07]
 i 21 + 1 0.5 [0.8*0/1] [8+.08]
 i 21 + 1 1.25 [0.75*1/1] [8+.00]
 i 21 + 1 3 [0.85*0/1] [8+.10]
 i 21 + 1 1.25 [0.2*0/1] [8+.02]
