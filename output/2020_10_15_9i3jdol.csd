...
mixolydiandorian; dorian tr808 voices=1
t 0 320
b [(6*4*8*1)-4*4*6] ; loop1 dorian

{ 6 CNT
i 4 [0+0+$CNT*4*4] 1 0.5 [0.45*1/1] [9+.10+0.06]
 i 4 + 1 1.5 [0.95*0/1] [9+.02+0.06]
 i 4 + 1 0.25 [0.55*0/1] [9+.12+0.06]
 i 4 + 1 0.25 [0.35*1/1] [9+.10+0.06]
 i 4 + 1 0.25 [0.25*0/1] [9+.07+0.06]
 i 4 + 1 1 [0.6*1/1] [9+.00+0.06]
 i 4 + 1 0.5 [0.95*1/1] [9+.00+0.06]
 i 4 + 1 0.25 [0.75*0/1] [9+.02+0.06]
 i 4 + 1 0.25 [0.5*1/1] [9+.03+0.06]
 i 4 + 1 0.5 [0.85*1/1] [9+.02+0.06]
 i 4 + 1 0.5 [0.3*1/1] [9+.07+0.06]
 i 4 + 1 1.25 [0.85*0/1] [9+.07+0.06]
 i 4 + 1 1 [0.8*1/1] [9+.02+0.06]
 i 4 + 1 2.75 [0.8*0/1] [9+.00+0.06]
 i 4 + 1 1.25 [0.6*0/1] [9+.10+0.06]
 i 4 + 1 0.5 [0.9*0/1] [9+.03+0.06]
}


; evolve 1 dorian
i 4 + 1 1 [0.7*0/1] [9+.02+0.06]
 i 4 + 1 1.5 [0.95*0/1] [9+.02+0.06]
 i 4 + 1 0.25 [0.55*0/1] [9+.12+0.06]
 i 4 + 1 0.25 [0.35*1/1] [9+.10+0.06]
 i 4 + 1 0.25 [0.25*0/1] [9+.07+0.06]
 ...
 i 4 + 1 2.75 [0.8*0/1] [9+.00+0.06]
 i 4 + 1 1.25 [0.6*0/1] [9+.10+0.06]
 i 4 + 1 1 [0.95*0/1] [9+.10+0.06]
 i 4 + 1 1 [0.7*0/1] [9+.02+0.06]
 i 4 + 1 2.75 [0.9*1/1] [9+.00+0.06]
 i 4 + 1 0.25 [0.55*0/1] [9+.12+0.06]
 i 4 + 1 0.25 [0.35*1/1] [9+.10+0.06]
 i 4 + 1 0.25 [0.25*0/1] [9+.07+0.06]
 i 4 + 1 1 [0.6*1/1] [9+.00+0.06]
 i 4 + 1 1.25 [0.5*0/1] [9+.02+0.06]
 i 4 + 1 1 [0.4*0/1] [9+.05+0.06]
 i 4 + 1 0.25 [0.5*1/1] [9+.03+0.06]
 i 4 + 1 0.5 [0.85*1/1] [9+.02+0.06]
 i 4 + 1 0.25 [0.35*0/1] [9+.07+0.06]
 i 4 + 1 1.25 [0.85*0/1] [9+.07+0.06]
 i 4 + 1 1 [0.8*1/1] [9+.02+0.06]
 i 4 + 1 1.5 [0.55*1/1] [9+.07+0.06]
 i 4 + 1 2.75 [0.7*0/1] [9+.02+0.06]
 i 4 + 1 1 [0.95*0/1] [9+.10+0.06]
 i 4 + 1 1 [0.7*0/1] [9+.02+0.06]
 i 4 + 1 2.75 [0.9*1/1] [9+.00+0.06]
 i 4 + 1 0.25 [0.55*0/1] [9+.12+0.06]
 i 4 + 1 1.5 [0.8*0/1] [9+.00+0.06]
 i 4 + 1 0.25 [0.25*0/1] [9+.07+0.06]
 i 4 + 1 1 [0.6*1/1] [9+.00+0.06]
 i 4 + 1 1.25 [0.5*0/1] [9+.02+0.06]
 i 4 + 1 1 [0.4*0/1] [9+.05+0.06]
 ...
 i 4 + 1 1.25 [0.85*0/1] [9+.07+0.06]
 i 4 + 1 1 [0.8*1/1] [9+.02+0.06]
 i 4 + 1 0.25 [0.7*0/1] [9+.00+0.06]
 i 4 + 1 2.75 [0.7*0/1] [9+.02+0.06]
 i 4 + 1 3 [0.9*0/1] [9+.09+0.06]

; evovle 2, dorian
i 4 + 1 1 [0.7*0/1] [9+.02+0.06]
 i 4 + 1 0.5 [0.45*0/1] [9+.00+0.06]
 i 4 + 1 0.25 [0.55*0/1] [9+.12+0.06]
 i 4 + 1 1.5 [0.8*0/1] [9+.00+0.06]
 i 4 + 1 0.25 [0.25*0/1] [9+.07+0.06]
 i 4 + 1 1 [0.6*1/1] [9+.00+0.06]
 i 4 + 1 1.25 [0.5*0/1] [9+.02+0.06]
 i 4 + 1 1 [0.4*0/1] [9+.05+0.06]
 i 4 + 1 2.75 [0.8*1/1] [9+.00+0.06]
 i 4 + 1 0.5 [0.85*1/1] [9+.02+0.06]
 i 4 + 1 1.5 [0.2*0/1] [9+.12+0.06]
 i 4 + 1 1.25 [0.85*0/1] [9+.07+0.06]
 i 4 + 1 2.75 [0.8*0/1] [9+.00+0.06]
 i 4 + 1 0.25 [0.7*0/1] [9+.00+0.06]
 i 4 + 1 2.75 [0.7*0/1] [9+.02+0.06]
 ...
 i 4 + 1 1 [0.7*0/1] [9+.02+0.06]
 i 4 + 1 0.5 [0.45*0/1] [9+.00+0.06]
 i 4 + 1 0.25 [0.55*1/1] [9+.00+0.06]
 i 4 + 1 0.75 [0.25*1/1] [9+.12+0.06]
 i 4 + 1 0.25 [0.25*0/1] [9+.07+0.06]
 i 4 + 1 1.25 [0.5*0/1] [9+.10+0.06]
 i 4 + 1 1.25 [0.5*0/1] [9+.02+0.06]
 i 4 + 1 1 [0.4*0/1] [9+.05+0.06]
 i 4 + 1 1 [0.85*1/1] [9+.09+0.06]
 i 4 + 1 0.5 [0.85*1/1] [9+.02+0.06]
 i 4 + 1 1.5 [0.2*0/1] [9+.12+0.06]
 i 4 + 1 1.25 [0.85*0/1] [9+.07+0.06]
 i 4 + 1 2.75 [0.8*0/1] [9+.00+0.06]
 ...
 i 4 + 1 0.5 [0.45*0/1] [9+.00+0.06]
 i 4 + 1 0.25 [0.55*1/1] [9+.00+0.06]
 i 4 + 1 2.75 [0.4*1/1] [9+.09+0.06]
 i 4 + 1 0.25 [0.25*0/1] [9+.07+0.06]
 i 4 + 1 0.25 [0.65*1/1] [9+.12+0.06]
 i 4 + 1 1.25 [0.5*0/1] [9+.02+0.06]
 i 4 + 1 0.5 [0.5*1/1] [9+.00+0.06]
 i 4 + 1 1 [0.85*1/1] [9+.09+0.06]
 i 4 + 1 0.5 [0.85*1/1] [9+.02+0.06]
 i 4 + 1 1.5 [0.2*0/1] [9+.12+0.06]
 i 4 + 1 1.25 [0.85*0/1] [9+.07+0.06]
 ...
 i 4 + 1 0.5 [0.5*1/1] [9+.00+0.06]
 i 4 + 1 1 [0.85*1/1] [9+.09+0.06]
 i 4 + 1 1 [0.8*0/1] [9+.03+0.06]
 i 4 + 1 1.5 [0.2*0/1] [9+.12+0.06]
 i 4 + 1 0.25 [0.45*1/1] [9+.09+0.06]
 i 4 + 1 2.75 [0.8*0/1] [9+.00+0.06]
 i 4 + 1 0.25 [0.7*0/1] [9+.00+0.06]
 i 4 + 1 0.75 [0.3*0/1] [9+.07+0.06]
 i 4 + 1 3 [0.9*0/1] [9+.09+0.06]
 i 4 + 1 1 [0.7*0/1] [9+.02+0.06]
 i 4 + 1 0.5 [0.45*0/1] [9+.00+0.06]
 i 4 + 1 1 [0.85*0/1] [9+.00+0.06]
 i 4 + 1 2.75 [0.4*1/1] [9+.09+0.06]
 i 4 + 1 0.25 [0.25*0/1] [9+.07+0.06]
 i 4 + 1 0.25 [0.65*1/1] [9+.12+0.06]
 i 4 + 1 1.25 [0.5*0/1] [9+.02+0.06]
 i 4 + 1 0.5 [0.95*0/1] [9+.00+0.06]
 i 4 + 1 1 [0.85*1/1] [9+.09+0.06]
 i 4 + 1 1 [0.8*0/1] [9+.03+0.06]
 i 4 + 1 1.5 [0.2*0/1] [9+.12+0.06]
 i 4 + 1 1.5 [0.6*1/1] [9+.02+0.06]
 i 4 + 1 2.75 [0.8*0/1] [9+.00+0.06]
 i 4 + 1 0.25 [0.7*0/1] [9+.00+0.06]
 i 4 + 1 0.75 [0.3*0/1] [9+.07+0.06]
 i 4 + 1 3 [0.9*0/1] [9+.09+0.06]
 ...
 i 4 + 1 0.5 [0.45*0/1] [9+.00+0.06]
 i 4 + 1 1 [0.85*0/1] [9+.00+0.06]
 i 4 + 1 0.25 [0.75*0/1] [9+.10+0.06]
 i 4 + 1 0.25 [0.25*0/1] [9+.07+0.06]
 i 4 + 1 0.25 [0.65*1/1] [9+.12+0.06]
 i 4 + 1 1.25 [0.5*0/1] [9+.02+0.06]
 i 4 + 1 0.5 [0.95*0/1] [9+.00+0.06]
 i 4 + 1 0.75 [0.35*0/1] [9+.00+0.06]
 i 4 + 1 1 [0.8*0/1] [9+.03+0.06]
 i 4 + 1 1.5 [0.2*0/1] [9+.12+0.06]
 i 4 + 1 1.5 [0.6*1/1] [9+.02+0.06]
 i 4 + 1 2.75 [0.8*0/1] [9+.00+0.06]
