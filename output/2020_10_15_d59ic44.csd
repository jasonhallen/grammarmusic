...
; atonal atonal tr808 voices=1
t 0 420
b [(6*4*8*1)-3*4*6] ; loop1 atonal

{ 6 CNT
i 101 [0+0+$CNT*3*4] 1 0.25 [0.9*1/1] [8+.09+0.9]
 i 101 + 1 0.75 [0.5*0/1] [8+.07+0.9]
 i 101 + 1 3 [0.95*0/1] [8+.07+0.9]
 i 101 + 1 0.5 [0.7*0/1] [8+.05+0.9]
 i 101 + 1 0.25 [0.8*1/1] [8+.04+0.9]
 i 101 + 1 0.5 [0.7*1/1] [8+.05+0.9]
 i 101 + 1 0.25 [0.9*0/1] [8+.02+0.9]
 i 101 + 1 1.25 [0.85*1/1] [8+.02+0.9]
 i 101 + 1 0.5 [0.8*0/1] [8+.01+0.9]
 i 101 + 1 2.75 [0.55*1/1] [8+.08+0.9]
 i 101 + 1 1.25 [0.95*0/1] [8+.06+0.9]
 i 101 + 1 0.25 [0.5*1/1] [8+.06+0.9]
}


; evolve 1 atonal
i 101 + 1 0.5 [0.35*0/1] [8+.01+0.9]
 i 101 + 1 0.75 [0.5*0/1] [8+.07+0.9]
 i 101 + 1 3 [0.95*0/1] [8+.07+0.9]
 i 101 + 1 0.5 [0.7*0/1] [8+.05+0.9]
 i 101 + 1 0.25 [0.8*1/1] [8+.04+0.9]
 ...
 i 101 + 1 0.5 [0.9*0/1] [8+.03+0.9]
 i 101 + 1 3 [0.95*0/1] [8+.07+0.9]
 i 101 + 1 0.5 [0.75*0/1] [8+.06+0.9]
 i 101 + 1 0.25 [0.9*0/1] [8+.10+0.9]
 i 101 + 1 0.5 [0.7*1/1] [8+.05+0.9]
 i 101 + 1 0.25 [0.9*0/1] [8+.02+0.9]
 i 101 + 1 1.25 [0.85*1/1] [8+.02+0.9]
 i 101 + 1 0.5 [0.6*1/1] [8+.09+0.9]
...
i 101 + 1 0.5 [0.35*0/1] [8+.01+0.9]
 ...
 i 101 + 1 0.5 [0.6*1/1] [8+.09+0.9]
 i 101 + 1 2.75 [0.55*1/1] [8+.08+0.9]
 i 101 + 1 1 [0.7*0/1] [8+.00+0.9]
 i 101 + 1 0.5 [0.65*1/1] [8+.11+0.9]
 i 101 + 1 0.5 [0.35*0/1] [8+.01+0.9]
 i 101 + 1 0.75 [0.4*1/1] [8+.00+0.9]
 i 101 + 1 1.25 [0.85*1/1] [8+.11+0.9]
 i 101 + 1 0.5 [0.75*0/1] [8+.06+0.9]
 i 101 + 1 0.25 [0.9*0/1] [8+.10+0.9]
 i 101 + 1 0.5 [0.7*1/1] [8+.05+0.9]
 i 101 + 1 0.25 [0.9*0/1] [8+.02+0.9]
 ...
 i 101 + 1 0.5 [0.6*1/1] [8+.09+0.9]
 i 101 + 1 2.75 [0.55*1/1] [8+.08+0.9]
 i 101 + 1 3 [0.7*0/1] [8+.09+0.9]
 i 101 + 1 0.5 [0.65*1/1] [8+.11+0.9]
 i 101 + 1 0.5 [0.35*0/1] [8+.01+0.9]
 i 101 + 1 0.5 [0.85*1/1] [8+.00+0.9]
 i 101 + 1 0.25 [0.4*0/1] [8+.08+0.9]
 i 101 + 1 0.5 [0.75*0/1] [8+.06+0.9]
 i 101 + 1 0.25 [0.9*0/1] [8+.10+0.9]
 i 101 + 1 0.5 [0.7*1/1] [8+.05+0.9]
 i 101 + 1 2.75 [0.8*1/1] [8+.09+0.9]
 i 101 + 1 0.5 [0.95*0/1] [8+.04+0.9]
 i 101 + 1 0.5 [0.6*1/1] [8+.09+0.9]
 i 101 + 1 2.75 [0.55*1/1] [8+.08+0.9]
 i 101 + 1 3 [0.7*0/1] [8+.09+0.9]
 i 101 + 1 0.5 [0.65*1/1] [8+.11+0.9]
 ...
 i 101 + 1 0.25 [0.3*0/1] [8+.00+0.9]
 i 101 + 1 0.5 [0.6*1/1] [8+.09+0.9]
 i 101 + 1 0.5 [0.2*1/1] [8+.02+0.9]
 i 101 + 1 3 [0.7*0/1] [8+.09+0.9]
 i 101 + 1 1.5 [0.85*1/1] [8+.02+0.9]
 i 101 + 1 0.5 [0.35*0/1] [8+.01+0.9]
 i 101 + 1 0.5 [0.85*1/1] [8+.00+0.9]
 i 101 + 1 0.25 [0.4*0/1] [8+.08+0.9]
 i 101 + 1 0.5 [0.75*0/1] [8+.06+0.9]
